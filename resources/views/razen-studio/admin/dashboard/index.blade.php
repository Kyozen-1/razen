...
@section('title', 'Admin - Razen Studio | Dashboard')
...
<div class="row">
    ...
    <div class="scroll-out">
        ...
        <div class="card mb-2">
            ...
            <div class="col-auto">
                ...
                <img src="{{ asset('acorn/acorn-elearning-portal/img/course/small/course-1.webp') }}" alt="alternate text" class="card-img card-img-horizontal sw-14 sw-lg-18" />
                </a>
            </div>
            <div class="col">
        ...
        <div class="card mb-2">
            ...
            <div class="col-auto">
                <a href="Course.Detail.html" class="d-block position-relative h-100">
                <img src="{{ asset('acorn/acorn-elearning-portal/img/course/small/course-2.webp') }}" alt="alternate text" class="card-img card-img-horizontal sw-14 sw-lg-18" />
                </a>
            </div>
            <div class="col">
                <div class="card-body pt-0 pb-0 h-100 d-flex align-items-center">
        ...
        <div class="card mb-2">
            ...
            <div class="col-auto">
                <a href="Course.Detail.html" class="d-block position-relative h-100">
                <img src="{{ asset('acorn/acorn-elearning-portal/img/course/small/course-3.webp') }}" alt="alternate text" class="card-img card-img-horizontal sw-14 sw-lg-18" />
                </a>
            </div>
            <div class="col">
                <div class="card-body pt-0 pb-0 h-100 d-flex align-items-center">
        ...
        <div class="card mb-2">
            ...
            <div class="col-auto">
                <a href="Course.Detail.html" class="d-block position-relative h-100">
                <img src="{{ asset('acorn/acorn-elearning-portal/img/course/small/course-4.webp') }}" alt="alternate text" class="card-img card-img-horizontal sw-14 sw-lg-18" />
                </a>
            </div>
            <div class="col">
                <div class="card-body pt-0 pb-0 h-100 d-flex align-items-center">
        ...
        <div class="card mb-2">
            ...
            <div class="col-auto">
                <a href="Course.Detail.html" class="d-block position-relative h-100">
                <img src="{{ asset('acorn/acorn-elearning-portal/img/course/small/course-5.webp') }}" alt="alternate text" class="card-img card-img-horizontal sw-14 sw-lg-18" />
                </a>
            </div>
            <div class="col">
                <div class="card-body pt-0 pb-0 h-100 d-flex align-items-center">
    ...
    <div class="card w-100 sh-50 sh-md-40 h-xl-100-card hover-img-scale-up position-relative">
        <img src="{{ asset('acorn/acorn-elearning-portal/img/banner/cta-standard-3.webp') }}" class="card-img h-100 scale position-absolute" alt="card image" />
...
<div class="row row-cols-1 row-cols-md-2 row-cols-xl-5 g-2 mb-5">
    ...
    <div class="card h-100">
        <img src="{{ asset('acorn/acorn-elearning-portal/img/course/small/course-4.webp') }}" class="card-img-top sh-22" alt="card image" />
        <div class="card-body">
    ...
    <div class="col">
    <div class="card h-100">
        <img src="{{ asset('acorn/acorn-elearning-portal/img/course/small/course-5.webp') }}" class="card-img-top sh-22" alt="card image" />
        <div class="card-body">
    ...
    <div class="card h-100">
        ...
        <img src="{{ asset('acorn/acorn-elearning-portal/img/course/small/course-6.webp') }}" class="card-img-top sh-22" alt="card image" />
        <div class="card-body">
    ...
    <div class="col">
    <div class="card h-100">
        <img src="{{ asset('acorn/acorn-elearning-portal/img/course/small/course-7.webp') }}" class="card-img-top sh-22" alt="card image" />
        <div class="card-body">
    ...
    <div class="card h-100">
        <img src="{{ asset('acorn/acorn-elearning-portal/img/course/small/course-9.webp') }}" class="card-img-top sh-22" alt="card image" />
        <div class="card-body">
...
<div class="row">
    ...
    <div class="card sh-40 h-xl-100-card">
        ...
        <div class="text-center">
            <img src="{{ asset('acorn/acorn-elearning-portal/img/illustration/icon-analytics.webp') }}" class="theme-filter mb-3" alt="launch" />
