...
@section('content')
    ...
    <div class="row mb-3">
        <div class="col-12" style="text-align:right">
            <a class="btn btn-outline-primary waves-effect waves-light mr-2 item_create" href="{{ route('razen-studio.admin.web-development.data.harga-website.create') }}"><i class="fas fa-plus"></i></a>
        </div>
    </div>
    ...
    <div class="data-table-rows slim">
        ...
        <div class="data-table-responsive-wrapper">
            <table id="harga_website_table" class="data-table w-100">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Aksi</th>
...
@section('js')
    ...
    <script>
        $(document).ready(function(){
            var dataTables = $('#harga_website_table').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: "{{ route('razen-studio.admin.web-development.data.harga-website.index') }}"
                },
                columns: [
                    {
                        data: 'DT_RowIndex',
        ...
        $('#ok_button').click(function(){
            var url = "{{ route('razen-studio.admin.web-development.data.harga-website.destroy', ['id' => ":user_id"]) }}";
            ...
            $.ajax({
                ...
                success: function(data)
                {
                    ...
                    $('#harga_website_table').DataTable().ajax.reload(null, false);
                }
            });
        });
    </script>
