...
@section('title', 'Admin - Razen Studio | Digital Campaign | Iklan Facebook')
...
<div class="page-title-container">
    <div class="row">
        ...
        <div class="col-12 col-md-7">
            <h1 class="mb-0 pb-0 display-4" id="title">Digital Campaign - Iklan Facebook</h1>
            <nav class="breadcrumb-container d-inline-block" aria-label="breadcrumb">
                <ul class="breadcrumb pt-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('razen-studio.admin.digital-campaign.iklan-facebook.index') }}">Iklan Facebook</a></li>
                </ul>
            </nav>
        </div>
        <!-- Title End -->
...
<h2 class="small-title">Iklan Facebook</h2>
...
<div class="card mb-5">
    <div class="card-body">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <img src="{{ asset('images/landingpage_razenstudio_screenshot/digital-campaign/iklan-facebook/section_1.png') }}" alt="" class="img-fluid rounded">
            </div>
        </div>
        <form action="{{ route('razen-studio.admin.digital-campaign.iklan-facebook.section-1.store') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-12">
                    <div class="mb-3 position-relative form-group">
                        <label for="" class="form-label">Title</label>
                        <input type="text" class="form-control" name="title" placeholder="Untuk title pada page" value="{{$iklan_facebook_section_1?$iklan_facebook_section_1['title']:'' }}" required>
                    </div>
                    <div class="mb-3 position-relative form-group">
                        <label for="" class="form-label">Judul</label>
                        <input type="text" class="form-control" name="judul" placeholder="Jasa Desain Logo" value="{{$iklan_facebook_section_1?$iklan_facebook_section_1['judul']:'' }}" required>
                    </div>
                    <div class="mb-3 position-relative form-group">
                        <label for="" class="form-label">Deskripsi</label>
                        <textarea name="deskripsi" rows="5" class="form-control" placeholder="Layanan jasa desain logo berkualitas yang dikerjakan oleh tim desainer profesional." required>{{$iklan_facebook_section_1 ? $iklan_facebook_section_1['deskripsi']:''}}</textarea>
                    </div>
                </div>
            </div>
...
<div class="card mb-5">
    <div class="card-body">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <img src="{{ asset('images/landingpage_razenstudio_screenshot/digital-campaign/iklan-facebook/section_2.png') }}" alt="" class="img-fluid rounded">
            </div>
        </div>
        <form action="{{ route('razen-studio.admin.digital-campaign.iklan-facebook.section-2.store') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-12 col-md-8">
                    <div class="mb-3 position-relative form-group">
                        <label for="" class="form-label">Judul</label>
                        <input type="text" class="form-control" name="judul" placeholder="Desain yang bagus?" value="{{$iklan_facebook_section_2?$iklan_facebook_section_2['judul']:'' }}" required>
                    </div>
                    <div class="mb-3 position-relative form-group">
                        <label for="" class="form-label">Deskripsi</label>
                        <textarea name="deskripsi" rows="5" class="form-control" id="section_2" required>{{$iklan_facebook_section_2 ? $iklan_facebook_section_2['deskripsi']:''}}</textarea>
                    </div>
                </div>
                <div class="col-12 col-md-4">
                    <div class="position-relative form-group">
                        <label for="" class="form-label">Gambar</label>
                        @if ($iklan_facebook_section_2)
                        <input type="file" class="dropify" name="gambar" data-height="300" data-allowed-file-extensions="png jpg jpeg webp" data-default-file="{{ asset('images/landingpage_razenstudio/digital-campaign/iklan-facebook/'.$iklan_facebook_section_2['gambar']) }}" data-show-errors="true" required>
                        @else
...
<div class="card mb-5">
    <div class="card-body">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <img src="{{ asset('images/landingpage_razenstudio_screenshot/digital-campaign/iklan-facebook/section_3.png') }}" alt="" class="img-fluid rounded">
            </div>
        </div>
        <form action="{{ route('razen-studio.admin.digital-campaign.iklan-facebook.section-3.store') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-12 col-md-8">
                    <div class="mb-3 position-relative form-group">
                        <label for="" class="form-label">Judul</label>
                        <input type="text" class="form-control" name="judul" placeholder="Desain yang bagus?" value="{{$iklan_facebook_section_3?$iklan_facebook_section_3['judul']:'' }}" required>
                    </div>
                    <div class="mb-3 position-relative form-group">
                        <label for="" class="form-label">Deskripsi</label>
                        <textarea name="deskripsi" rows="5" class="form-control" id="section_3" required>{{$iklan_facebook_section_3 ? $iklan_facebook_section_3['deskripsi']:''}}</textarea>
                    </div>
                </div>
                <div class="col-12 col-md-4">
                    <div class="position-relative form-group">
                        <label for="" class="form-label">Gambar</label>
                        @if ($iklan_facebook_section_3)
                        <input type="file" class="dropify" name="gambar" data-height="300" data-allowed-file-extensions="png jpg jpeg webp" data-default-file="{{ asset('images/landingpage_razenstudio/digital-campaign/iklan-facebook/'.$iklan_facebook_section_3['gambar']) }}" data-show-errors="true" required>
                        @else
                        <input type="file" class="dropify" name="gambar" data-height="300" data-allowed-file-extensions="png jpg jpeg webp" data-show-errors="true" required>
                        @endif
                    </div>
...
<div class="card mb-5">
    <div class="card-body">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <img src="{{ asset('images/landingpage_razenstudio_screenshot/digital-campaign/iklan-facebook/section_4.png') }}" alt="" class="img-fluid rounded">
            </div>
        </div>
        <form action="{{ route('razen-studio.admin.digital-campaign.iklan-facebook.section-4.store') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-12">
                    <div class="mb-3 position-relative form-group">
                        <label for="" class="form-label">Judul</label>
                        <input type="text" class="form-control" name="judul" placeholder="Desain yang bagus?" value="{{$iklan_facebook_section_4?$iklan_facebook_section_4['judul']:'' }}" required>
                    </div>
                    <div class="mb-3 position-relative form-group">
                        <label for="" class="form-label">Deskripsi</label>
                        <textarea name="deskripsi" rows="5" class="form-control" required>{{$iklan_facebook_section_4 ? $iklan_facebook_section_4['deskripsi']:''}}</textarea>
                    </div>
                </div>
            </div>
            <button type="submit" class="btn btn-primary mb-0">Submit</button>
...
<div class="card mb-5">
    <div class="card-body">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <img src="{{ asset('images/landingpage_razenstudio_screenshot/digital-campaign/iklan-facebook/section_5.png') }}" alt="" class="img-fluid rounded">
            </div>
        </div>
        @if ($iklan_facebook_section_5 == null)
            <form action="{{ route('razen-studio.admin.digital-campaign.iklan-facebook.section-5.store') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-12">
                        <div class="mb-3 position-relative form-group">
        ...
        @endif
        @if ($iklan_facebook_section_5 != null)
            <form action="{{ route('razen-studio.admin.digital-campaign.iklan-facebook.section-5.edit') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-12">
                        <div class="mb-3 position-relative form-group">
                            <label for="" class="form-label">Judul</label>
                            <input type="text" class="form-control" name="judul" value="{{$iklan_facebook_section_5['judul']}}" required>
                        </div>
                        <div class="mb-3 position-relative form-group">
                            <div class="row mb-3">
...
<div class="card mb-5">
    <div class="card-body">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <img src="{{ asset('images/landingpage_razenstudio_screenshot/digital-campaign/iklan-facebook/section_6.png') }}" alt="" class="img-fluid rounded">
            </div>
        </div>
        <form class="mb-3" action="{{ route('razen-studio.admin.digital-campaign.iklan-facebook.section-6.store') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-12">
                    <div class="mb-3 position-relative form-group">
                        <label for="" class="form-label">Judul</label>
                        <input type="text" class="form-control" name="judul" placeholder="Jasa Video Marketing" value="{{$iklan_facebook_section_6?$iklan_facebook_section_6['judul']:'' }}" required>
                    </div>
                    <div class="mb-3 position-relative form-group">
                        <label for="" class="form-label">Deskripsi</label>
                        <textarea name="deskripsi" rows="5" class="form-control" required>{{$iklan_facebook_section_6 ? $iklan_facebook_section_6['deskripsi']:''}}</textarea>
                    </div>
                </div>
            </div>
            <button type="submit" class="btn btn-primary mb-0">Submit</button>
        </form>
        <form class="mb-3" action="{{ route('razen-studio.admin.digital-campaign.iklan-facebook.section-6.item-1.store') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-12 col-md-4">
                ...
                <div class="col-12 col-md-8">
                    ...
                    @if ($iklan_facebook_section_6 != null)
                        @foreach ($iklan_facebook_section_6['item'] as $item)
                            @if ($item['item'] == 'item_1')
                                <div class="mb-3 position-relative form-group">
                                    <label for="" class="form-label">Judul</label>
                                ...
                                <div class="mb-3 position-relative form-group">
                                    ...
                                    <input type="file" class="dropify" name="ikon" data-height="300" data-allowed-file-extensions="png jpg jpeg webp" data-default-file="{{ asset('images/landingpage_razenstudio/digital-campaign/iklan-facebook/'.$item['ikon']) }}" data-show-errors="true" required>
                                </div>
        ...
        <form action="{{ route('razen-studio.admin.digital-campaign.iklan-facebook.section-6.item-2.store') }}" class="mb-3" novalidate="novalidate" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-12 col-md-4">
        ...
        <form action="{{ route('razen-studio.admin.digital-campaign.iklan-facebook.section-6.item-3.store') }}" class="mb-3" novalidate="novalidate" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-12 col-md-4">
        ...
        <form action="{{ route('razen-studio.admin.digital-campaign.iklan-facebook.section-6.item-4.store') }}" class="mb-3" novalidate="novalidate" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-12 col-md-4">
                    ...
                    @if ($iklan_facebook_section_6 != null)
                        @foreach ($iklan_facebook_section_6['item'] as $item)
                            @if ($item['item'] == 'item_4')
                                ...
                                <div class="mb-3 position-relative form-group">
                                    <label for="" class="form-label">Gambar</label>
                                    <input type="file" class="dropify" name="gambar" data-height="300" data-allowed-file-extensions="png jpg jpeg webp" data-default-file="{{ asset('images/landingpage_razenstudio/digital-campaign/iklan-facebook/'.$item['gambar']) }}" data-show-errors="true" required>
                                </div>
                                <div class="mb-3 position-relative form-group">
...
<div class="card mb-5">
    <div class="card-body">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <img src="{{ asset('images/landingpage_razenstudio_screenshot/digital-campaign/iklan-facebook/section_7.png') }}" alt="" class="img-fluid rounded">
            </div>
        </div>
        <form action="{{ route('razen-studio.admin.digital-campaign.iklan-facebook.section-7.store') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-12">
                    <div class="mb-3 position-relative form-group">
                        <label for="" class="form-label">Sub Judul</label>
                        <input type="text" class="form-control" name="sub_judul" placeholder="Pricing" value="{{$iklan_facebook_section_7?$iklan_facebook_section_7['sub_judul']:'' }}" required>
                    </div>
                    <div class="mb-3 position-relative form-group">
                        <label for="" class="form-label">Judul</label>
                        <input type="text" class="form-control" name="judul" placeholder="Paket Harga Iklan Instagram" value="{{$iklan_facebook_section_7?$iklan_facebook_section_7['judul']:'' }}" required>
                    </div>
                    <div class="mb-3 position-relative form-group">
                        <label for="" class="form-label">Deskripsi</label>
                        <textarea name="deskripsi" rows="5" class="form-control" placeholder="Paket iklan akan disesuaikan dengan budget iklan yang akan dikeluarkan setiap bulannya.." required>{{$iklan_facebook_section_7 ? $iklan_facebook_section_7['deskripsi']:''}}</textarea>
                    </div>
                </div>
            </div>
            <button type="submit" class="btn btn-primary mb-0">Submit</button>
...
<div class="card mb-5">
    <div class="card-body">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <img src="{{ asset('images/landingpage_razenstudio_screenshot/digital-campaign/iklan-facebook/section_8.png') }}" alt="" class="img-fluid rounded">
            </div>
        </div>
        @if ($iklan_facebook_section_8 == null)
            <form action="{{ route('razen-studio.admin.digital-campaign.iklan-facebook.section-8.store') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-12">
                        <div class="mb-3 position-relative form-group">
        ...
        @endif
        @if ($iklan_facebook_section_8 != null)
            <form action="{{ route('razen-studio.admin.digital-campaign.iklan-facebook.section-8.edit') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-12">
                        <div class="mb-3 position-relative form-group">
                                ...
                                @foreach ($iklan_facebook_section_8 as $item)
                                    <div class="col-12 col-md-4 mb-5">
                                        <div class="card h-100 border">
                                            ...
                                            <img src="{{ asset('images/landingpage_razenstudio/digital-campaign/iklan-facebook/'.$item['logo_konten']) }}" class="card-img-top sh-22" alt="card image">
                                            <div class="card-body">
...
<div class="card mb-5">
    <div class="card-body">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <img src="{{ asset('images/landingpage_razenstudio_screenshot/digital-campaign/iklan-facebook/section_9.png') }}" alt="" class="img-fluid rounded">
            </div>
        </div>
        @if ($iklan_facebook_section_9 == null)
            <form action="{{ route('razen-studio.admin.digital-campaign.iklan-facebook.section-9.store') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-12">
                        <div class="mb-3 position-relative form-group">
        ...
        @endif
        @if ($iklan_facebook_section_9 != null)
            <form action="{{ route('razen-studio.admin.digital-campaign.iklan-facebook.section-9.edit') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-12">
                        <div class="mb-3 position-relative form-group">
                            <label for="" class="form-label">Sub Judul</label>
                            <input type="text" class="form-control" name="sub_judul" placeholder="What we do" value="{{ $iklan_facebook_section_9['sub_judul'] }}" required>
                        </div>
                        <div class="mb-3 position-relative form-group">
                            <label for="" class="form-label">Judul</label>
                            <input name="judul" class="form-control" placeholder="Jasa Digital Marketing" value="{{$iklan_facebook_section_9['judul']}}" required>
                        </div>
                        <div class="mb-3 position-relative form-group">
                            <div class="row mb-3">
...
<div class="card mb-5">
    <div class="card-body">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <img src="{{ asset('images/landingpage_razenstudio_screenshot/digital-campaign/iklan-facebook/section_10.png') }}" alt="" class="img-fluid rounded">
            </div>
        </div>
        @if ($iklan_facebook_section_10  == null)
            <form action="{{ route('razen-studio.admin.digital-campaign.iklan-facebook.section-10.store') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-12">
                        <div class="mb-3 position-relative form-group">
        ...
        @endif
        @if ($iklan_facebook_section_10  != null)
            <form action="{{ route('razen-studio.admin.digital-campaign.iklan-facebook.section-10.edit') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-12">
                        <div class="mb-3 position-relative form-group">
                            <label for="" class="form-label">Sub Judul</label>
                            <input type="text" class="form-control" name="sub_judul" value="{{$iklan_facebook_section_10 ['sub_judul']}}" placeholder="FAQ" required>
                        </div>
                        <div class="mb-3 position-relative form-group">
                            <label for="" class="form-label">Judul</label>
                            <input type="text" class="form-control" name="judul" value="{{$iklan_facebook_section_10 ['judul']}}" required>
                        </div>
                        <div class="mb-3 position-relative form-group">
                            <div class="row mb-3">
    ...
    <script>
        ...
        $('.btn_hapus_data_section5').click(function(){
            ...
            return new swal({
                ...
                {
                    $.ajax({
                        url: "{{ route('razen-studio.admin.digital-campaign.iklan-facebook.section-5.hapus.satu') }}",
                        method: "POST",
                        data: {
                            "_token": "{{ csrf_token() }}",
                            id:id
        ...
        $('.btn_hapus_gambar_section8').click(function(){
            ...
            return new swal({
                ...
                {
                    $.ajax({
                        url: "{{ route('razen-studio.admin.digital-campaign.iklan-facebook.section-8.hapus.satu') }}",
                        method: "POST",
                        data: {
                            "_token": "{{ csrf_token() }}",
                            id:id
        ...
        $('.btn_hapus_gambar_section9').click(function(){
            ...
            return new swal({
                ...
                {
                    $.ajax({
                        url: "{{ route('razen-studio.admin.digital-campaign.iklan-facebook.section-9.hapus.satu') }}",
                        method: "POST",
                        data: {
                            "_token": "{{ csrf_token() }}",
                            id:id
        ...
        $('.btn_hapus_data_section10').click(function(){
            ...
            return new swal({
                ...
                {
                    $.ajax({
                        url: "{{ route('razen-studio.admin.digital-campaign.iklan-facebook.section-10.hapus.satu') }}",
                        method: "POST",
                        data: {
                            "_token": "{{ csrf_token() }}",
                            id:id
