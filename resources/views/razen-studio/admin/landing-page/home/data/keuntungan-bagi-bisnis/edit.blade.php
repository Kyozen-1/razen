...
@section('title', 'Admin - Razen Studio | Admin | Landing Page | Home | Data | Keuntungan Bagi Bisnis | Edit')
...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('razen-studio.admin.home.data.keuntungan-bagi-bisnis.update', ['id' => $id]) }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row mb-3">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-4">
                            ...
                            <select name="in_house[status]" id="" class="form-control" required>
                                ...
                                <option value="Belum Tentu" @if($in_house['status'] == 'Belum Tentu') selected @endif>Belum Tentu</option>
                            </select>
                        </div>
                        <div class="col-12 col-md-4">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-4">
                            ...
                            <select name="freelance[status]" id="" class="form-control" required>
                                <option value="">--- Pilih ---</option>
                                <option value="Ya" @if($freelance['status'] == 'Ya') selected @endif>Ya</option>
                                <option value="Tidak" @if($freelance['status'] == 'Tidak') selected @endif>Tidak</option>
                                <option value="Belum Tentu" @if($freelance['status'] == 'Belum Tentu') selected @endif>Belum Tentu</option>
                                <option value="Perlu ada yang mengatur" @if($freelance['status'] == 'Perlu ada yang mengatur') selected @endif>Perlu ada yang mengatur</option>
                            </select>
                        </div>
                        <div class="col-12 col-md-4">
                            <label for="" class="form-label">Status Keterangan</label>
                    ...
                    <div class="row">
                        <div class="col-12 col-md-4">
                            ...
                            <select name="digital_agency_hub[status]" id="" class="form-control" required>
                                ...
                                <option value="Tidak perlu" @if($digital_agency_hub['Tidak perlu'] == 'Ya') selected @endif>Tidak perlu</option>
                            </select>
                        </div>
                        <div class="col-12 col-md-4">
                            <label for="" class="form-label">Status Keterangan</label>
