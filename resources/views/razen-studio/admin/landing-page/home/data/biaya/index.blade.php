...
@section('title', 'Admin - Razen Studio | Admin | Landing Page | Home | Data | Biaya')
...
@section('content')
    ...
    <div class="row mb-3">
        <div class="col-12" style="text-align:right">
            <a class="btn btn-outline-primary waves-effect waves-light mr-2 item_create" href="{{ route('razen-studio.admin.home.data.biaya.create') }}"><i class="fas fa-plus"></i></a>
        </div>
    </div>
    ...
    <div class="data-table-rows slim">
        ...
        <div class="data-table-responsive-wrapper">
            <table id="biaya_table" class="data-table w-100">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Aksi</th>
                        <th>Nama</th>
                        <th>In House</th>
                        <th>Freelance / Agency</th>
                        <th>Digital Agency Hub</th>
                    </tr>
                </thead>
            </table>
        </div>
...
@section('js')
    ...
    <script>
        $(document).ready(function(){
            ...
            var dataTables = $('#biaya_table').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: "{{ route('razen-studio.admin.home.data.biaya.index') }}"
                },
                columns: [
                    {
                        data: 'DT_RowIndex',
                    ...
                    {
                        data: 'digital_agency_hub',
                        name: 'digital_agency_hub'
                    },
                ]
            });
        });
        ...
        $('#ok_button').click(function(){
            var url = "{{ route('razen-studio.admin.home.data.biaya.destory', ['id' => ":user_id"]) }}";
            ...
            $.ajax({
                ...
                success: function(data)
                {
                    ...
                    $('#biaya_table').DataTable().ajax.reload(null, false);
                }
            });
        });
    </script>
