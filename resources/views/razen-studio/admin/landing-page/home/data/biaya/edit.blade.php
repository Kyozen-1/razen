...
@section('title', 'Admin - Razen Studio | Admin | Landing Page | Home | Data | Biaya | Edit')
...
@section('content')
    ...
    <div class="page-title-container">
        ...
        <div class="col-12 col-md-7">
            <h1 class="mb-0 pb-0 display-4" id="title">Biaya</h1>
            <nav class="breadcrumb-container d-inline-block" aria-label="breadcrumb">
                <ul class="breadcrumb pt-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('razen-studio.admin.home.data.biaya.index') }}">Biaya</a></li>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('razen-studio.admin.home.data.biaya.update', ['id' => $id]) }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row mb-3">
                    ...
                    <div class="col-6" style="text-align:right">
                        <a href="{{ route('razen-studio.admin.home.data.biaya.index') }}" class="btn btn-danger btn-icon waves-effect waves-light"><i class="fas fa-arrow-left"></i></a>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-12 col-md-4">
                            ...
                            <select name="in_house[status]" id="" class="form-control" required>
                                ...
                                <option value="1" @if($in_house['status'] == '1') selected @endif>Ya</option>
                                <option value="0" @if($in_house['status'] == '0') selected @endif>Tidak</option>
                            </select>
                        </div>
                        <div class="col-12 col-md-4">
                            ...
                            <select name="in_house[status_keterangan]" id="in_house_status_keterangan" class="form-control" required>
                                <option value="">--- Pilih ---</option>
                                <option value="1" @if($in_house['status_keterangan'] == '1') selected @endif>Ya</option>
                                <option value="0" @if($in_house['status_keterangan'] == '0') selected @endif>Tidak</option>
                            </select>
                        </div>
                        <div class="col-12 col-md-4" id="col_in_house_keterangan">
                            @if($in_house['status_keterangan'] == '1')
                                <label for="" class="form-label">Keterangan</label>
                                <textarea name="in_house[keterangan]" rows="5" class="form-control" required>{{$in_house['keterangan']}}</textarea>
                            @endif
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-12 col-md-4">
                            ...
                            <select name="freelance[status]" id="" class="form-control" required>
                                <option value="">--- Pilih ---</option>
                                <option value="Tidak perlu" @if($freelance['status'] == 'Tidak perlu') selected @endif>Tidak perlu</option>
                                <option value="Tidak ada standard" @if($freelance['status'] == 'Tidak ada standard') selected @endif>Tidak ada standard</option>
                            </select>
                        </div>
                        <div class="col-12 col-md-4">
                            <label for="" class="form-label">Status Keterangan</label>
                            <select name="freelance[status_keterangan]" id="freelance_status_keterangan" class="form-control" required>
                                <option value="">--- Pilih ---</option>
                                <option value="1" @if($freelance['status_keterangan'] == '1') selected @endif>Ya</option>
                                <option value="0" @if($freelance['status_keterangan'] == '0') selected @endif>Tidak</option>
                            </select>
                        </div>
                        <div class="col-12 col-md-4" id="col_freelance_keterangan">
                            @if($freelance['status_keterangan'] == '1')
                                <label for="" class="form-label">Keterangan</label>
                                <textarea name="freelance[keterangan]" rows="5" class="form-control" required>{{$freelance['keterangan']}}</textarea>
                            @endif
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-12 col-md-4">
                            ...
                            <select name="digital_agency_hub[status]" id="" class="form-control" required>
                                <option value="">--- Pilih ---</option>
                                <option value="Ya" @if($digital_agency_hub['status'] == 'Ya') selected @endif>Ya</option>
                                <option value="Tidak perlu" @if($digital_agency_hub['status'] == 'Tidak perlu') selected @endif>Tidak perlu</option>
                                <option value="Tidak ada standard" @if($digital_agency_hub['status'] == 'Tidak ada standard') selected @endif>Tidak ada standard</option>
                            </select>
                        </div>
                        <div class="col-12 col-md-4">
                            <label for="" class="form-label">Status Keterangan</label>
                            <select name="digital_agency_hub[status_keterangan]" id="digital_agency_hub_status_keterangan" class="form-control" required>
                                <option value="">--- Pilih ---</option>
                                <option value="1" @if($digital_agency_hub['status_keterangan'] == '1') selected @endif>Ya</option>
                                <option value="0" @if($digital_agency_hub['status_keterangan'] == '0') selected @endif>Tidak</option>
                            </select>
                        </div>
                        <div class="col-12 col-md-4" id="col_digital_agency_hub_keterangan">
                            @if($digital_agency_hub['status_keterangan'] == '1')
                                <label for="" class="form-label">Keterangan</label>
                                <textarea name="digital_agency_hub[keterangan]" rows="5" class="form-control" required>{{$digital_agency_hub['keterangan']}}</textarea>
                            @endif
                        </div>
                    </div>
                </div>
...
@section('js')
    ...
    <script>
        var in_house = <?php echo $data->in_house; ?>;

        var freelance = <?php echo $data->freelance; ?>;

        var digital_agency_hub = <?php echo $data->digital_agency_hub; ?>;
        ...
        $('#in_house_status_keterangan').change(function(){
            ...
            if(value == '1')
            {
                ...
                if('keterangan' in in_house)
                {
                    $("[name='in_house[keterangan]']").val(in_house['keterangan']);
                }
            } else {
