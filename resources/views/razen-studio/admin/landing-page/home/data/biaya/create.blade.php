...
@section('title', 'Admin - Razen Studio | Admin | Landing Page | Home | Data | Biaya | Create')
...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('razen-studio.admin.home.data.biaya.store') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row mb-3">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-4">
                            ...
                            <select name="freelance[status]" id="" class="form-control" required>
                                ...
                                <option value="Tidak ada standard">Tidak ada standard</option>
                            </select>
                        </div>
                        <div class="col-12 col-md-4">
                            <label for="" class="form-label">Status Keterangan</label>
