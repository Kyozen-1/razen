...
@section('title', 'Admin - Razen Studio | Visual Branding Design | Jasa Desain Grafis | Atur')
...
<div class="page-title-container">
    <div class="row">
        ...
        <div class="col-12 col-md-7">
            <h1 class="mb-0 pb-0 display-4" id="title">Jasa Desain Grafis - Atur</h1>
            <nav class="breadcrumb-container d-inline-block" aria-label="breadcrumb">
                <ul class="breadcrumb pt-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('razen-studio.admin.visual-branding-design.jasa-desain-grafis.atur.index') }}">Atur</a></li>
                </ul>
            </nav>
        </div>
        <!-- Title End -->
...
<h2 class="small-title">Jasa Desain Grafis</h2>
...
<div class="card mb-5">
    <div class="card-body">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <img src="{{ asset('images/landingpage_razenstudio_screenshot/visual-branding-design/jasa-desain-grafis/section_1.png') }}" alt="" class="img-fluid rounded">
            </div>
        </div>
        <form action="{{ route('razen-studio.admin.visual-branding-design.jasa-desain-grafis.atur.section-1.store') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-12">
                    <div class="mb-3 position-relative form-group">
                        <label for="" class="form-label">Title</label>
                        <input type="text" class="form-control" name="title" placeholder="Untuk title pada page" value="{{$jasa_branding_design_section_1?$jasa_branding_design_section_1['title']:'' }}" required>
                    </div>
                    <div class="mb-3 position-relative form-group">
                        <label for="" class="form-label">Judul</label>
                        <input type="text" class="form-control" name="judul" placeholder="Jasa Desain Grafis" value="{{$jasa_branding_design_section_1?$jasa_branding_design_section_1['judul']:'' }}" required>
                    </div>
                    <div class="mb-3 position-relative form-group">
                        <label for="" class="form-label">Deskripsi</label>
                        <textarea name="deskripsi" rows="5" class="form-control" placeholder="Pilihan layanan jasa desain berkualitas & profesional yang dikerjakan oleh tim desainer pilihan untuk meningkatkan branding bisnis secara visual dengan style terkini." required>{{$jasa_branding_design_section_1 ? $jasa_branding_design_section_1['deskripsi']:''}}</textarea>
                    </div>
                </div>
            </div>
...
<div class="card mb-5">
    <div class="card-body">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <img src="{{ asset('images/landingpage_razenstudio_screenshot/visual-branding-design/jasa-desain-grafis/section_2.png') }}" alt="" class="img-fluid rounded">
            </div>
        </div>
        <form action="{{ route('razen-studio.admin.visual-branding-design.jasa-desain-grafis.atur.section-2.store') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-12 col-md-8">
                    <div class="mb-3 position-relative form-group">
                        <label for="" class="form-label">Sub Judul</label>
                        <input type="text" class="form-control" name="sub_judul" placeholder="APA PENTINGNYA" value="{{$jasa_branding_design_section_2?$jasa_branding_design_section_2['sub_judul']:''}}" required>
                    </div>
                    <div class="mb-3 position-relative form-group">
                        <label for="" class="form-label">Judul</label>
                        <input type="text" class="form-control" name="judul" placeholder="Desain yang bagus?" value="{{$jasa_branding_design_section_2?$jasa_branding_design_section_2['judul']:'' }}" required>
                    </div>
                    <div class="mb-3 position-relative form-group">
                        <label for="" class="form-label">Deskripsi</label>
                        <textarea name="deskripsi" rows="5" class="form-control" id="section_2" required>{{$jasa_branding_design_section_2 ? $jasa_branding_design_section_2['deskripsi']:''}}</textarea>
                    </div>
                    <div class="mb-3 position-relative form-group">
                        <label for="" class="form-label">Link Youtube</label>
                        <input type="text" class="form-control" name="link" placeholder="" value="{{$jasa_branding_design_section_2?$jasa_branding_design_section_2['link']:'' }}" required>
                    </div>
                </div>
                <div class="col-12 col-md-4">
                    <div class="position-relative form-group">
                        <label for="" class="form-label">Gambar</label>
                        @if ($jasa_branding_design_section_2)
                        <input type="file" class="dropify" name="gambar" data-height="300" data-allowed-file-extensions="png jpg jpeg webp" data-default-file="{{ asset('images/landingpage_razenstudio/visual-branding-design/jasa-desain-grafis/'.$jasa_branding_design_section_2['gambar']) }}" data-show-errors="true" required>
                        @else
...
<div class="card mb-5">
    <div class="card-body">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <img src="{{ asset('images/landingpage_razenstudio_screenshot/visual-branding-design/jasa-desain-grafis/section_3.png') }}" alt="" class="img-fluid rounded">
            </div>
        </div>
        @if ($jasa_branding_design_section_3 == null)
            <form action="{{ route('razen-studio.admin.visual-branding-design.jasa-desain-grafis.atur.section-3.store') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-12">
                        <div class="mb-3 position-relative form-group">
                            <label for="" class="form-label">Sub Judul</label>
                            <input type="text" class="form-control" name="sub_judul" placeholder="LAYANAN DESAIN TERLENGKAP" required>
                        </div>
                        <div class="mb-3 position-relative form-group">
                            <label for="" class="form-label">Judul</label>
                            <input name="judul" class="form-control" placeholder="Pilihan Jasa Branding & Desain Lainnya" required>
                        </div>
                        <div class="mb-3 position-relative form-group">
                            <div class="row">
                                <div class="col-6">
        ...
        @endif
        @if ($jasa_branding_design_section_3 != null)
            <form action="{{ route('razen-studio.admin.visual-branding-design.jasa-desain-grafis.atur.section-3.edit') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-12">
                        <div class="mb-3 position-relative form-group">
                            <label for="" class="form-label">Sub Judul</label>
                            <input type="text" class="form-control" name="sub_judul" placeholder="LAYANAN DESAIN TERLENGKAP" value="{{ $jasa_branding_design_section_3['sub_judul'] }}" required>
                        </div>
                        <div class="mb-3 position-relative form-group">
                            <label for="" class="form-label">Judul</label>
                            <input name="judul" class="form-control" placeholder="Pilihan Jasa Branding & Desain Lainnya" value="{{$jasa_branding_design_section_3['judul']}}" required>
                        </div>
                        <div class="mb-3 position-relative form-group">
                            <div class="row mb-3">
                                @foreach ($jasa_branding_design_section_3['konten'] as $item)
                                    <div class="col-12 col-md-4 mb-5">
                                        <div class="card h-100 border">
                                            ...
                                            <img src="{{ asset('images/landingpage_razenstudio/visual-branding-design/jasa-desain-grafis/'.$item['gambar_konten']) }}" class="card-img-top sh-22" alt="card image">
                                            <div class="card-body">
...
<div class="card mb-5">
    <div class="card-body">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <img src="{{ asset('images/landingpage_razenstudio_screenshot/visual-branding-design/jasa-desain-grafis/section_4.png') }}" alt="" class="img-fluid rounded">
            </div>
        </div>
        @if ($jasa_branding_design_section_4 == null)
            <form action="{{ route('razen-studio.admin.visual-branding-design.jasa-desain-grafis.atur.section-4.store') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-12">
                        <div class="mb-3 position-relative form-group">
        ...
        @endif
        @if ($jasa_branding_design_section_4 != null)
            <form action="{{ route('razen-studio.admin.visual-branding-design.jasa-desain-grafis.atur.section-4.edit') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-12">
                        <div class="mb-3 position-relative form-group">
                            <label for="" class="form-label">Sub Judul</label>
                            <input type="text" class="form-control" name="sub_judul" placeholder="LAYANAN DESAIN TERLENGKAP" value="{{ $jasa_branding_design_section_4['sub_judul'] }}" required>
                        </div>
                        <div class="mb-3 position-relative form-group">
                            <label for="" class="form-label">Judul</label>
                            <input name="judul" class="form-control" placeholder="Pilihan Jasa Branding & Desain Lainnya" value="{{$jasa_branding_design_section_4['judul']}}" required>
                        </div>
                        <div class="mb-3 position-relative form-group">
                            <div class="row mb-3">
    ...
    <div class="card-body">
        ...
        <div class="row mb-3">
            <div class="col-12 text-center">
                <img src="{{ asset('images/landingpage_razenstudio_screenshot/visual-branding-design/jasa-desain-grafis/section_5.png') }}" alt="" class="img-fluid rounded">
            </div>
        </div>
        <form action="{{ route('razen-studio.admin.visual-branding-design.jasa-desain-grafis.atur.section-5.store') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-12">
                    <div class="mb-3 position-relative form-group">
                        <label for="" class="form-label">Sub Judul</label>
                        <input type="text" class="form-control" name="sub_judul" placeholder="OUR LATEST WORK" value="{{$jasa_branding_design_section_5?$jasa_branding_design_section_5['sub_judul']:'' }}" required>
                    </div>
                    <div class="mb-3 position-relative form-group">
                        <label for="" class="form-label">Judul</label>
                        <input type="text" class="form-control" name="judul" placeholder="Jasa Desain Grafis" value="{{$jasa_branding_design_section_5?$jasa_branding_design_section_5['judul']:'' }}" required>
                    </div>
                    <div class="mb-3 position-relative form-group">
                        <label for="" class="form-label">Deskripsi</label>
                        <textarea name="deskripsi" rows="5" class="form-control" placeholder="Ribuan bisnis di Indonesia telah menggunakan jasa desain grafis kami." required>{{$jasa_branding_design_section_5 ? $jasa_branding_design_section_5['deskripsi']:''}}</textarea>
                    </div>
                </div>
            </div>
            <button type="submit" class="btn btn-primary mb-0">Submit</button>
...
<script>
    ...
    function dynamic_section3(number)
    {
        ...
        html += '<input name="link_konten[]" rows="5" class="form-control" required>';
        html += '</div>';
        html += '</div>';
    ...
    $('.btn_hapus_gambar_section3').click(function(){
        ...
        return new swal({
            ...
            {
                $.ajax({
                    url: "{{ route('razen-studio.admin.visual-branding-design.jasa-desain-grafis.atur.section-3.hapus.satu') }}",
                    method: "POST",
                    data: {
                        "_token": "{{ csrf_token() }}",
                        id:id
