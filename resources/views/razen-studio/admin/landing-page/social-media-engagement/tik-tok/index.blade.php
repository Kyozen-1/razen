...
@section('title', 'Admin - Razen Studio | Social Media Engagement | TikTok')
...
@php
    ...
    $tiktok = LandingpageRazenstudioSocialMediaEngagementTikTok::first();
    if($tiktok)
    {
        $section1 = json_decode($tiktok->section_1, true);
        $section2 = json_decode($tiktok->section_2, true);
        $section3 = json_decode($tiktok->section_3, true);
        $section4 = json_decode($tiktok->section_4, true);
        $section5 = json_decode($tiktok->section_5, true);
        $section6 = json_decode($tiktok->section_6, true);
        $section7 = json_decode($tiktok->section_7, true);
        $section8 = json_decode($tiktok->section_8, true);
    } else {
        $section1 = [];
        $section2 = [];
        $section3 = [];
...
<div class="page-title-container">
    ...
    <div class="col-12 col-md-7">
        <h1 class="mb-0 pb-0 display-4" id="title">Social Media Engegament - TikTok</h1>
        <nav class="breadcrumb-container d-inline-block" aria-label="breadcrumb">
            <ul class="breadcrumb pt-0">
                ...
                <li class="breadcrumb-item"><a href="{{ route('razen-studio.admin.social-media-engagement.tik-tok.index') }}">TikTok</a></li>
            </ul>
        </nav>
    </div>
    <!-- Title End -->
...
<h2 class="small-title">Tiktok</h2>
...
<div class="card mb-5">
    <div class="card-body">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <img src="{{ asset('images/landingpage_razenstudio_screenshot/social-media-engagement/tik-tok/section_1.png') }}" alt="" class="img-fluid rounded">
            </div>
        </div>
        <form action="{{ route('razen-studio.admin.social-media-engagement.tik-tok.section-1.store') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-12">
...
<div class="card mb-5">
    <div class="card-body">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <img src="{{ asset('images/landingpage_razenstudio_screenshot/social-media-engagement/tik-tok/section_2.png') }}" alt="" class="img-fluid rounded">
            </div>
        </div>
        <form action="{{ route('razen-studio.admin.social-media-engagement.tik-tok.section-2.store') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-12 col-md-7">
                    <div class="mb-3 position-relative form-group">
                ...
                <div class="col-12 col-md-5">
                    <div class="position-relative form-group">
                        ...
                        @if ($section2)
                        <input type="file" class="dropify" name="gambar" data-height="300" data-allowed-file-extensions="png jpg jpeg webp" data-default-file="{{ asset('images/landingpage_razenstudio/social-media-engagement/tik-tok/'.$section2['gambar']) }}" data-show-errors="true" required>
                        @else
...
<div class="card mb-5">
    <div class="card-body">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <img src="{{ asset('images/landingpage_razenstudio_screenshot/social-media-engagement/tik-tok/section_3.png') }}" alt="" class="img-fluid rounded">
            </div>
        </div>
        <form action="{{ route('razen-studio.admin.social-media-engagement.tik-tok.section-3.store') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-12 col-md-7">
                    <div class="mb-3 position-relative form-group">
                ...
                <div class="col-12 col-md-5">
                    <div class="position-relative form-group">
                        <label for="" class="form-label">Gambar</label>
                        @if ($section3)
                        <input type="file" class="dropify" name="gambar" data-height="300" data-allowed-file-extensions="png jpg jpeg" data-default-file="{{ asset('images/landingpage_razenstudio/social-media-engagement/tik-tok/'.$section3['gambar']) }}" data-show-errors="true" required>
                        @else
...
<div class="card mb-5">
    <div class="card-body">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <img src="{{ asset('images/landingpage_razenstudio_screenshot/social-media-engagement/tik-tok/section_4.png') }}" alt="" class="img-fluid rounded">
            </div>
        </div>
        <form action="{{ route('razen-studio.admin.social-media-engagement.tik-tok.section-4.store') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-12 col-md-7">
                    <div class="mb-3 position-relative form-group">
                ...
                <div class="col-12 col-md-5">
                    <div class="position-relative form-group">
                        <label for="" class="form-label">Gambar</label>
                        @if ($section4)
                        <input type="file" class="dropify" name="gambar" data-height="300" data-allowed-file-extensions="png jpg jpeg" data-default-file="{{ asset('images/landingpage_razenstudio/social-media-engagement/tik-tok/'.$section4['gambar']) }}" data-show-errors="true" required>
                        @else
                        <input type="file" class="dropify" name="gambar" data-height="300" data-allowed-file-extensions="png jpg jpeg" data-show-errors="true" required>
                        @endif
                    </div>
...
<div class="card mb-5">
    <div class="card-body">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <img src="{{ asset('images/landingpage_razenstudio_screenshot/social-media-engagement/tik-tok/section_5.png') }}" alt="" class="img-fluid rounded">
            </div>
        </div>
        <form action="{{ route('razen-studio.admin.social-media-engagement.tik-tok.section-5.store') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-12">
                    <div class="mb-3 position-relative form-group">
...
<div class="card mb-5">
    <div class="card-body">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <img src="{{ asset('images/landingpage_razenstudio_screenshot/social-media-engagement/tik-tok/section_6.png') }}" alt="" class="img-fluid rounded">
            </div>
        </div>
        @if ($section6 == null)
            <form action="{{ route('razen-studio.admin.social-media-engagement.tik-tok.section-6.store') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-12">
                        <div class="mb-3 position-relative form-group">
        ...
        @endif
        @if ($section6 != null)
            <form action="{{ route('razen-studio.admin.social-media-engagement.tik-tok.section-6.edit') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-12">
                        <div class="mb-3 position-relative form-group">
...
<div class="card mb-5">
    <div class="card-body">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <img src="{{ asset('images/landingpage_razenstudio_screenshot/social-media-engagement/tik-tok/section_7.png') }}" alt="" class="img-fluid rounded">
            </div>
        </div>
        <form action="{{ route('razen-studio.admin.social-media-engagement.tik-tok.section-7.store') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-12">
                    <div class="mb-3 position-relative form-group">
...
<div class="card mb-5">
    <div class="card-body">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <img src="{{ asset('images/landingpage_razenstudio_screenshot/social-media-engagement/tik-tok/section_8.png') }}" alt="" class="img-fluid rounded">
            </div>
        </div>
        <form action="{{ route('razen-studio.admin.social-media-engagement.tik-tok.section-8.store') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-12 col-md-7">
                    <div class="mb-3 position-relative form-group">
                ...
                <div class="col-12 col-md-5">
                    <div class="position-relative form-group">
                        <label for="" class="form-label">Gambar</label>
                        @if ($section8)
                        <input type="file" class="dropify" name="gambar" data-height="300" data-allowed-file-extensions="png jpg jpeg" data-default-file="{{ asset('images/landingpage_razenstudio/social-media-engagement/tik-tok/'.$section8['gambar']) }}" data-show-errors="true" required>
                        @else
                        <input type="file" class="dropify" name="gambar" data-height="300" data-allowed-file-extensions="png jpg jpeg" data-show-errors="true" required>
                        @endif
                    </div>
...
<script>
    ...
    $('.btn_hapus_data_section6').click(function(){
        ...
        return new swal({
            ...
            {
                $.ajax({
                    url: "{{ route('razen-studio.admin.social-media-engagement.tik-tok.section-6.hapus.satu') }}",
                    method: "POST",
                    data: {
                        "_token": "{{ csrf_token() }}",
                        id:id
