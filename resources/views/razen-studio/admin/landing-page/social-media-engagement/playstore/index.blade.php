...
@section('title', 'Admin - Razen Studio | Social Media Engagement | Playstore')
...
if($playstore)
{
    $section1 = json_decode($playstore->section_1, true);
    $section2 = json_decode($playstore->section_2, true);
    $section3 = json_decode($playstore->section_3, true);
    $section4 = json_decode($playstore->section_4, true);
    $section5 = json_decode($playstore->section_5, true);
    $section6 = json_decode($playstore->section_6, true);
} else {
    $section1 = [];
    $section2 = [];
    $section3 = [];
...
<div class="col-12 col-md-7">
    <h1 class="mb-0 pb-0 display-4" id="title">Social Media Engegament - Playstore</h1>
    <nav class="breadcrumb-container d-inline-block" aria-label="breadcrumb">
        <ul class="breadcrumb pt-0">
            ...
            <li class="breadcrumb-item"><a href="{{ route('razen-studio.admin.social-media-engagement.playstore.index') }}">Playstore</a></li>
        </ul>
    </nav>
</div>
<!-- Title End -->
...
<h2 class="small-title">Playstore</h2>
...
<div class="card mb-5">
    <div class="card-body">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <img src="{{ asset('images/landingpage_razenstudio_screenshot/social-media-engagement/playstore/section_1.png') }}" alt="" class="img-fluid rounded">
            </div>
        </div>
        <form action="{{ route('razen-studio.admin.social-media-engagement.playstore.section-1.store') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-12">
...
<div class="card mb-5">
    <div class="card-body">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <img src="{{ asset('images/landingpage_razenstudio_screenshot/social-media-engagement/playstore/section_2.png') }}" alt="" class="img-fluid rounded">
            </div>
        </div>
        <form action="{{ route('razen-studio.admin.social-media-engagement.playstore.section-2.store') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-12 col-md-7">
                    <div class="mb-3 position-relative form-group">
                ...
                <div class="col-12 col-md-5">
                    <div class="position-relative form-group">
                        ...
                        @if ($section2)
                        <input type="file" class="dropify" name="gambar" data-height="300" data-allowed-file-extensions="png jpg jpeg webp" data-default-file="{{ asset('images/landingpage_razenstudio/social-media-engagement/playstore/'.$section2['gambar']) }}" data-show-errors="true" required>
                        @else
...
<div class="card mb-5">
    <div class="card-body">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <img src="{{ asset('images/landingpage_razenstudio_screenshot/social-media-engagement/playstore/section_3.png') }}" alt="" class="img-fluid rounded">
            </div>
        </div>
        <form action="{{ route('razen-studio.admin.social-media-engagement.playstore.section-3.store') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-12 col-md-7">
                    <div class="mb-3 position-relative form-group">
                ...
                <div class="col-12 col-md-5">
                    <div class="position-relative form-group">
                        <label for="" class="form-label">Gambar</label>
                        @if ($section3)
                        <input type="file" class="dropify" name="gambar" data-height="300" data-allowed-file-extensions="png jpg jpeg" data-default-file="{{ asset('images/landingpage_razenstudio/social-media-engagement/playstore/'.$section3['gambar']) }}" data-show-errors="true" required>
                        @else
...
<div class="card mb-5">
    <div class="card-body">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <img src="{{ asset('images/landingpage_razenstudio_screenshot/social-media-engagement/playstore/section_4.png') }}" alt="" class="img-fluid rounded">
            </div>
        </div>
        <form action="{{ route('razen-studio.admin.social-media-engagement.playstore.section-4.store') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-12">
                    <div class="mb-3 position-relative form-group">
...
<div class="card mb-5">
    <div class="card-body">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <img src="{{ asset('images/landingpage_razenstudio_screenshot/social-media-engagement/playstore/section_5.png') }}" alt="" class="img-fluid rounded">
            </div>
        </div>
        <form action="{{ route('razen-studio.admin.social-media-engagement.playstore.section-5.store') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-12">
                    <div class="mb-3 position-relative form-group">
                    ...
                    <div class="mb-3 position-relative form-group">
                        <label for="" class="form-label">Deskripsi</label>
                        <textarea name="deskripsi" rows="5" class="form-control" id="section_5" required>{{$section5 ? $section5['deskripsi']:''}}</textarea>
                    </div>
                </div>
            </div>
            <button type="submit" class="btn btn-primary mb-0">Submit</button>
...
<div class="card mb-5">
    <div class="card-body">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <img src="{{ asset('images/landingpage_razenstudio_screenshot/social-media-engagement/playstore/section_6.png') }}" alt="" class="img-fluid rounded">
            </div>
        </div>
        @if ($section6 == null)
            <form action="{{ route('razen-studio.admin.social-media-engagement.playstore.section-6.store') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-12">
                        <div class="mb-3 position-relative form-group">
        ...
        @endif
        @if ($section6 != null)
            <form action="{{ route('razen-studio.admin.social-media-engagement.playstore.section-6.edit') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-12">
                        <div class="mb-3 position-relative form-group">
...
<script>
    ...
    $('.btn_hapus_data_section6').click(function(){
        ...
        return new swal({
            ...
            {
                $.ajax({
                    url: "{{ route('razen-studio.admin.social-media-engagement.playstore.section-6.hapus.satu') }}",
                    method: "POST",
                    data: {
                        "_token": "{{ csrf_token() }}",
                        id:id
