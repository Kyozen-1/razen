...
@section('title', 'Admin - Razen Studio | Reviewer | Atur')
        ...
        <div class="col">
            ...
            <div class="page-title-container">
                <div class="row">
                    ...
                    <div class="col-12 col-md-7">
                        <h1 class="mb-0 pb-0 display-4" id="title">Reviewer | Atur</h1>
                        <nav class="breadcrumb-container d-inline-block" aria-label="breadcrumb">
                            <ul class="breadcrumb pt-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('razen-studio.admin.landing-page.reviewer.index') }}">Atur</a></li>
                            </ul>
                        </nav>
                    </div>
                    <!-- Title End -->
            ...
            <div class="data-table-rows slim">
                ...
                <div class="data-table-responsive-wrapper">
                    <table id="reviewTable" class="data-table nowrap w-100">
                        <thead>
                            <tr>
                                <th class="text-muted text-small text-uppercase">No</th>
                                <th class="text-muted text-small text-uppercase">Nama</th>
                                <th class="text-muted text-small text-uppercase">Ulasan</th>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="reviewerForm" class="tooltip-label-end" novalidate enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="ulasan" id="ulasan" cols="30" rows="5" class="form-control" required></textarea>
                                </div>
                                <div class="mb-3">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group mb-3">
                    <label for="detail_ulasan" class="form-label" id="label_detail_ulasan">Ulasan</label>
                    <div id="detail_ulasan"></div>
                </div>
...
<script>
    $(document).ready(function(){
        ...
        var dataTables = $('#reviewTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: {
                url: "{{ route('razen-studio.admin.landing-page.reviewer.index') }}",
            },
            columns:[
                {
                    data: 'DT_RowIndex'
    ...
    $(document).on('click', '.detail', function(){
        var id = $(this).attr('id');
        $.ajax({
            url: "{{ url('/razen-studio/admin/landing-page/reviewer/detail') }}"+'/'+id,
            dataType: "json",
            success: function(data)
            {
                $('#detail_ulasan').remove();
                $('#label_detail_ulasan').after('<div id="detail_ulasan"></div>');
                $('#detail-title').text('Detail Data');
                $('#detail_nama').val(data.result.nama);
                $('#detail_ulasan').append(data.result.alasan);
                $('#detail_gambar').attr('src', "{{ asset('images/landingpage_razenstudio/reviewer') }}" + '/' + data.result.gambar);
                $('#detail').modal('show');
            }
        });
    });
    ...
    $('#reviewerForm').on('submit', function(e){
        ...
        {
            $.ajax({
                url: "{{ route('razen-studio.admin.landing-page.reviewer.store') }}",
                method: "POST",
        ...
        {
            $.ajax({
                url: "{{ route('razen-studio.admin.landing-page.reviewer.update') }}",
                method: "POST",
                data: new FormData(this),
                dataType: "json",
                contentType: false,
    ...
    $(document).on('click', '.edit', function(){
        ...
        $('#form_result').html('');
        $.ajax({
            url: "{{ url('/razen-studio/admin/landing-page/reviewer/edit') }}"+'/'+id,
            dataType: "json",
            success: function(data)
            {
                $('#nama').val(data.result.nama);
                $('#ulasan').val(data.result.ulasan);
                var lokasi_gambar = "{{ asset('images/landingpage_razenstudio/reviewer') }}"+'/'+data.result.gambar;
    ...
    $('#ok_button').click(function(){
        $.ajax({
            url: "{{ url('/razen-studio/admin/landing-page/reviewer/destroy') }}"+'/'+user_id,
            beforeSend: function(){
