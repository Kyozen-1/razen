...
@section('title', 'Admin - Razen Studio | Brand | Atur')
        ...
        <div class="col">
            ...
            <div class="page-title-container">
                <div class="row">
                    ...
                    <div class="col-12 col-md-7">
                        <h1 class="mb-0 pb-0 display-4" id="title">Brand | Atur</h1>
                        <nav class="breadcrumb-container d-inline-block" aria-label="breadcrumb">
                            <ul class="breadcrumb pt-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('razen-studio.admin.landing-page.brand.index') }}">Atur</a></li>
                            </ul>
                        </nav>
                    </div>
                    <!-- Title End -->
            ...
            <div class="data-table-rows slim">
                ...
                <div class="data-table-responsive-wrapper">
                    <table id="brandTable" class="data-table nowrap w-100">
                        <thead>
                            <tr>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="brandForm" class="tooltip-label-end" novalidate enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
...
<script>
    $(document).ready(function(){
        ...
        var dataTables = $('#brandTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: {
                url: "{{ route('razen-studio.admin.landing-page.brand.index') }}",
            },
            columns:[
                {
                    data: 'DT_RowIndex'
    ...
    $(document).on('click', '.detail', function(){
        var id = $(this).attr('id');
        $.ajax({
            url: "{{ url('/razen-studio/admin/landing-page/brand/detail') }}"+'/'+id,
            dataType: "json",
            success: function(data)
            {
                $('#detail-title').text('Detail Data');
                $('#detail_nama').val(data.result.nama);
                $('#detail_gambar').attr('src', "{{ asset('images/landingpage_razenstudio/brand') }}" + '/' + data.result.gambar);
                $('#detail').modal('show');
            }
        });
    });
    ...
    $('#brandForm').on('submit', function(e){
        ...
        {
            $.ajax({
                url: "{{ route('razen-studio.admin.landing-page.brand.store') }}",
                method: "POST",
        ...
        {
            $.ajax({
                url: "{{ route('razen-studio.admin.landing-page.brand.update') }}",
                method: "POST",
                data: new FormData(this),
                dataType: "json",
                contentType: false,
    ...
    $(document).on('click', '.edit', function(){
        ...
        $('#form_result').html('');
        $.ajax({
            url: "{{ url('/razen-studio/admin/landing-page/brand/edit') }}"+'/'+id,
            dataType: "json",
            success: function(data)
            {
                $('#nama').val(data.result.nama);
                var lokasi_gambar = "{{ asset('images/landingpage_razenstudio/brand') }}"+'/'+data.result.gambar;
    ...
    $('#ok_button').click(function(){
        $.ajax({
            url: "{{ url('/razen-studio/admin/landing-page/brand/destroy') }}"+'/'+user_id,
            beforeSend: function(){
