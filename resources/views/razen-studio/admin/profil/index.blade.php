...
@section('title', 'Admin - Razen Studio | Profil')
...
<!-- Title and Top Buttons Start -->
    <div class="page-title-container">
        ...
        <div class="col-12 col-md-7">
            <h1 class="mb-0 pb-0 display-4" id="title">Razen Studio | Profil</h1>
...
<!-- Content Start -->
    <div class="card mb-3">
        <div class="card-body">
            <form action="{{ route('razen-studio.admin.profil.store') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row mb-3">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-4">
                        <div class="mb-3 position-relative form-group">
                            ...
                            <input type="file" class="dropify" name="logo" data-height="300" data-allowed-file-extensions="png jpg jpeg webp" data-default-file="{{ asset('images/razen-studio/logo/'.$profil->logo) }}" data-show-errors="true" required>
                        </div>
                        <div class="mb-3 position-relative form-group">
                            <label for="logo_kecil" class="form-label">Logo Kecil</label>
                            <input type="file" name="logo_kecil" class="dropify" data-height="300" data-allowed-file-extensions="png jpg jpeg webp" data-default-file="{{ asset('images/razen-studio/logo/'.$profil->logo_kecil) }}" data-show-errors="true" required>
                        </div>
                    </div>
                </div>
            </form>
