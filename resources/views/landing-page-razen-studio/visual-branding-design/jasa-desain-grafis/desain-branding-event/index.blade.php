    ...
    <div class="container-fluid">
        <div class="row">
            <div class="breadcrumbs text-center link-style-5 text-white">
                <h1 class="section-title-page text-white">Jasa Desain Branding Event</h1>
                <p class="mb-5">Layanan jasa desain branding event nama berkualitas dan dikerjakan oleh tim yang profesional.</p>
                <ul class="breadcrumbs-inner list-center display-flex">
                    ...
                    <li>
                        <h4 class="section-16px-regular font-weight-500 text-white">Jasa Desain Branding Event</h4>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="col-md-6">
                <div class="about-content-right wow fadeInUp" data-wow-delay="0ms"
                    ...
                    <div class="section-title">
                        <h4 class="section-subtitle">JASA DESAIN BERBAGAI KEPERLUAN EVENT</h4>
                        <h4 class="section-45px-montserrat margin-top-15 margin-bottom-20">Desain Branding Event Berkualitas</h4>
                    </div>
                    <p class="section-17px-regular margin-bottom-25">
                        Dalam suatu event atau seminar pasti membutuhkan berbagai peralatan yang dapat menunjang berlangsungnya event tersebut, seperti ID Card, Sertifikat, Piagam, Dekorasi, dan sebagainya.
                        <br><br>
                        Jasa Desain Branding Event merupakan layanan yang menyediakan desain untuk berbagai keperluan dalam event. Desain akan mengikuti kebutuhan dan sesuai dengan tema dari event yang akan berlangsung.
                        <br><br>
                        Dengan Desain Branding Event Berkualitas akan meningkatkan branding serta profesionalitas event di hadapan audience Anda.
                    </p>
                </div>
            </div>
            <div class="col-md-6">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6">
                <div class="about-content-right wow fadeInUp" data-wow-delay="0ms"
                    data-wow-duration="1500ms">
                    <div class="section-title">
                        <h4 class="section-45px-montserrat margin-top-15 margin-bottom-20">Desain Berbagai Kebutuhan Event</h4>
                    </div>
                    <p class="section-17px-regular margin-bottom-25">
                        GoSocial menyediakan jasa desain untuk berbagai kebutuhan event, seperti Desain ID Card, Desain Piagam, Desain Sertifikat, Desain Dekorasi, dan lain-lain.
                        <br><br>
                        Dapatkan paket menarik untuk setiap kebutuhan desain branding event dan ciptakan visual desain branding event yang terbaik sesuai dengan kebutuhan dan tema event Anda.
                        <br><br>
                        Tingkatkan branding event Anda menggunakan Jasa Desain Branding Event Berkualitas dan Profesional bersama tim berpengalaman dari GoSocial. Diskusikan desain terbaik untuk eventmu bersama kami.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="section-title wow fadeInDown">
                    ...
                    <h2 class="section-45px-montserrat margin-top-15">Desain Branding Event</h2>
                </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="section-title wow fadeInDown">
                    ...
                    <p class="text-muted">Jasa Branding Event</p>
                </div>
                <div class="themesflat-spacer clearfix" data-desktop="47" data-mobile="60" data-smobile="60"
                    style="height:60px"></div>
            </div>
        ...
        <div class="row align-items-lg-center">
            <div id="stickyBlockStartPoint" class="col-lg-5 mb-9 mb-lg-0">
                ...
                <div class="card z-index-2 p-4 p-md-7">
                    ...
                    <hr class="my-4">
                    <div class="mb-5">
                        <p>Konsultasi dengan tim kami terlebih dahulu untuk strategi promosi event terbaik bagi bisnis Anda.</p>
                    </div>
                    <div class="mb-2">
