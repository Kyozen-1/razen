    ...
    <div class="container-fluid">
        <div class="row">
            <div class="breadcrumbs text-center link-style-5 text-white">
                <h1 class="section-title-page text-white">Jasa Desain Kemasan</h1>
                <p class="mb-5">Layanan jasa desain kemasan nama berkualitas dan dikerjakan oleh tim yang profesional.</p>
                <ul class="breadcrumbs-inner list-center display-flex">
                    ...
                    <li>
                        <h4 class="section-16px-regular font-weight-500 text-white">Jasa Desain Kemasan</h4>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="col-md-6">
                <div class="about-content-right wow fadeInUp" data-wow-delay="0ms"
                    ...
                    <div class="section-title">
                        <h4 class="section-subtitle">TINGKATKAN PENJUALAN DENGAN KEMASAN BERKUALITAS</h4>
                        <h4 class="section-45px-montserrat margin-top-15 margin-bottom-20">Jasa Desain Packaging Profesional</h4>
                    </div>
                    <p class="section-17px-regular margin-bottom-25">
                        Kemasan produk merupakan salah satu media promosi yang dapat menarik calon pembeli untuk melakukan transaksi terhadap suatu produk atau sering disebut sebagai "Packaging as The Silent Salesman".
                        <br><br>
                        GoSocial menyediakan layanan Jasa Desain Packaging/Kemasan Profesional untuk membantu bisnis Anda berkembang dan mendapatkan lebih banyak pembeli melalui desain kemasan yang berkualitas dan sesuai dengan informasi bisnis Anda.
                    </p>
                </div>
            </div>
            <div class="col-md-6">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6">
                <div class="about-content-right wow fadeInUp" data-wow-delay="0ms"
                    data-wow-duration="1500ms">
                    <div class="section-title">
                        <h4 class="section-45px-montserrat margin-top-15 margin-bottom-20">Layanan Desain Kemasan Custom</h4>
                    </div>
                    <p class="section-17px-regular margin-bottom-25">
                        GoSocial menawarkan Jasa Desain Kemasan untuk berbagai kebutuhan packaging produk Anda, seperti: kardus, box kue, tas belanja, botol minuman, kertas bungkus makanan, bungkus snack, pouch, dan berbagai model packaging lainnya sesuai permintaan.
                        <br><br>
                        Penuhi kebutuhan kemasan untuk berbagai jenis produk Anda serta tingkatkan branding bisnis dalam 1 tempat dengan desain kemasan yang profesional dan berpengalaman bersama tim GoSocial.
                        <br><br>
                        Melalui desain kemasan yang tepat dan sesuai dapat menarik pembeli lebih banyak sampai 3x lipat. Tingkatkan branding dan konversi sales bisnis Anda bersama kami!
                    </p>
                </div>
            </div>
        </div>
            ...
            <div id="stickyBlockStartPoint" class="col-lg-5 mb-9 mb-lg-0">
                ...
                <div class="card z-index-2 p-4 p-md-7">
                    <span class="text-dark">
                        <p>Mulai dari</p>
                        <span class="display-4">Rp. 250</span>
