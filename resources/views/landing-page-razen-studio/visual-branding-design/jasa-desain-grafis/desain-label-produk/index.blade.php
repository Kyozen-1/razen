    ...
    <div class="container-fluid">
        <div class="row">
            <div class="breadcrumbs text-center link-style-5 text-white">
                <h1 class="section-title-page text-white">Jasa Desain Label Produk</h1>
                <p class="mb-5">Layanan jasa desain label produk nama berkualitas dan dikerjakan oleh tim yang profesional.</p>
                <ul class="breadcrumbs-inner list-center display-flex">
                    ...
                    <li>
                        <h4 class="section-16px-regular font-weight-500 text-white">Jasa Desain Label Produk</h4>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="col-md-6">
                <div class="about-content-right wow fadeInUp" data-wow-delay="0ms"
                    ...
                    <div class="section-title">
                        <h4 class="section-subtitle">JASA PEMBUATAN LABEL PRODUK #1 INDONESIA</h4>
                        <h4 class="section-45px-montserrat margin-top-15 margin-bottom-20">Desain Label Online Profesional!</h4>
                    </div>
                    <p class="section-17px-regular margin-bottom-25">
                        Label meruapakan salah satu media promosi yang berfungsi untuk menguatkan brand suatu produk. Melalui label maka perusahaan yang membuat produk tersebut dapat mencantumkan informasi perusahaan, kualitas produk, petunjuk penggunaan, dan lain-lain dalam 1 media.
                        <br> <br>
                        Desain Label Produk yang profesional akan menarik minat calon customer untuk membaca dan mengetahui lebih lanjut tentang produk dan bisnis yang anda tawarkan.
                        <br> <br>
                        GoSocial menyediakan Jasa Desain Label Online Berkualitas untuk membantu bisnis dan produk Anda lebih dikenal oleh banyak orang.
                    </p>
                </div>
            </div>
            <div class="col-md-6">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6">
                <div class="about-content-right wow fadeInUp" data-wow-delay="0ms"
                    data-wow-duration="1500ms">
                    <div class="section-title">
                        <h4 class="section-45px-montserrat margin-top-15 margin-bottom-20">Desain Hangtag Berkualitas</h4>
                    </div>
                    <p class="section-17px-regular margin-bottom-25">
                        Hangtag merupakan label yang berisi tentang identitas perusahaan dan detail spesifikasi dari produk yang tengah dijual belikan. Hangtag dapat membuat brand menjadi lebih ekslusif serta meningkatkan kepercayaan calon customer terhadap branding suatu produk.
                        <br><br>
                        Dengan Desain Hangtag Berkualitas dapat menunjukan kelebihan dan spesifikasi produk sehingga dapat maksimal branding dan meningkatkan konversi sales secara efektif serta efisien
                        <br><br>
                        Mulai tingkatkan branding bisnis Anda dengan Jasa Desain Hang Tag Custom Berkualitas sesuai dengan produk dan identitas perusahaan Anda bersama tim berpengalaman di GoSocial.
                    </p>
                </div>
            </div>
        </div>
