    ...
    <div class="container-fluid">
        <div class="row">
            <div class="breadcrumbs text-center link-style-5 text-white">
                <h1 class="section-title-page text-white">Jasa Desain Kalender</h1>
                <p class="mb-5">Layanan jasa desain kalender berkualitas dan dikerjakan oleh tim yang profesional.</p>
                <ul class="breadcrumbs-inner list-center display-flex">
                    ...
                    <li>
                        <h4 class="section-16px-regular font-weight-500 text-white">Jasa Desain Kalender</h4>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="col-md-6">
                <div class="about-content-right wow fadeInUp" data-wow-delay="0ms"
                    ...
                    <div class="section-title">
                        <h4 class="section-subtitle">JASA DESAIN KALENDER MURAH DAN CEPAT</h4>
                        <h4 class="section-45px-montserrat margin-top-15 margin-bottom-20">Desain Kalender Profesional</h4>
                    </div>
                    <p class="section-17px-regular margin-bottom-25">
                        Kalender dapat digunakan sebagai sarana promosi offline yang optimal dengan mewakili pesan atau maksud tertentu perusahaan Anda dalam bentuk gambar dan sketsa yang berkualitas.
                        <br><br>
                        Desain Kalender yang bagus akan berdampak besar terhadap penjualan bisnis kamu. Dengan Jasa Desain Kalender Profesional dapat menciptakan branding yang kuat dan meningkatkan brand awareness kepada audience anda.
                        <br><br>
                        GoSocial menyediakan Jasa Desain Kalender dinding dan meja dengan murah dan cepat untuk mendukung kebutuhan promosi bisnis Anda.
                    </p>
                </div>
            </div>
            <div class="col-md-6">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6">
                <div class="about-content-right wow fadeInUp" data-wow-delay="0ms"
                    data-wow-duration="1500ms">
                    <div class="section-title">
                        <h4 class="section-45px-montserrat margin-top-15 margin-bottom-20">Manfaat Desain Kalender Berkualitas</h4>
                    </div>
                    <p class="section-17px-regular margin-bottom-25">
                        GoSocial menyediakan layanan Jasa Desain Kalender Berkualitas untuk memenuhi kebutuhan promosi bisnis dan meningkatkan brand awareness hingga konversi sales dari bisnis Anda.
                        <br><br>
                        Berikut adalah keuntungan lain dari Desain Kalender Berkualitas:
                        <br><br>
                        1. Meningkatkan Brand Awareness
                        <br>
                        2. Menjangkau target audiens dengan mudah dan lebih luas
                        <br>
                        3. Menciptakan branding yang kuat di dunia bisnis
                        <br>
                        4. Membantu meningkatkan angka Conversion Rate
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="section-title wow fadeInDown">
                    ...
                    <h2 class="section-45px-montserrat margin-top-15">Desain Kalender</h2>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="section-title wow fadeInDown">
                        ...
                        <h2 class="section-45px-montserrat margin-top-15">Jasa Desain Kalender</h2>
                    </div>
                    <div class="themesflat-spacer clearfix" data-desktop="47" data-mobile="60" data-smobile="60"
                        style="height:60px"></div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-4 mb-5">
                    ...
                    <div class="card shadow-lg h-100">
                        ...
                        <div class="card-header border-0 text-center mt-2">
                            <span class="d-block h2 mb-0">Paket Desain Kalender - Basic</span>
                        </div>
                        <!-- End Header -->
                        ...
                        <div class="card-body">
                            <div class="mb-3 text-center">
                                <span class="h3 font-size-3 text-primary">Rp. <span class="h1 font-size-4 text-primary">250</span>.000</span>
                            </div>
                        ...
                        <div class="card-footer border-0">
                            <a href="https://api.whatsapp.com/send?phone=6281234566636&amp;text=Halo%20GoSocial%21%0D%0ASaya%20ingin%20memesan%20layanan%20Desain%20Paket%20Desain%20Kalender%20-%20Basic%20Rp.%20250.000" target="_blank" type="button" class="btn btn-soft-primary btn-block transition-3d-hover font-size-2">Pesan Sekarang</a>
                        </div>
                    </div>
                    <!-- End Pricing -->
                </div>
                ...
                <div class="col-sm-6 col-lg-4 mb-5">
                    ...
                    <div class="card shadow-lg h-100">
                        <!-- Header -->
                        <div class="card-header border-0 text-center mt-2">
                            <span class="d-block h2 mb-0">Paket Desain Kalender - Premium 1</span>
                        </div>
                        <!-- End Header -->
                        ...
                        <div class="card-body">
                            <div class="mb-3 text-center">
                                <span class="h3 font-size-3 text-primary">Rp. <span class="h1 font-size-4 text-primary">450</span>.000</span>
                            </div>
                            <div class="media font-size-1 text-body mb-3 mt-5">
                                <svg style="width:24px;height:24px" viewBox="0 0 24 24" class="text-success mt-1 mr-2">
                                        <path fill="currentColor" d="M10,17L5,12L6.41,10.58L10,14.17L17.59,6.58L19,8M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z" />
                        ...
                        <div class="card-footer border-0">
                            <a href="https://api.whatsapp.com/send?phone=6281234566636&amp;text=Halo%20GoSocial%21%0D%0ASaya%20ingin%20memesan%20layanan%20Desain%20Paket%20Desain%20Kalender%20-%20Premium%201%20Rp.%20450.000" target="_blank" type="button" class="btn btn-soft-primary btn-block transition-3d-hover font-size-2">Pesan Sekarang</a>
                        </div>
                    </div>
                    <!-- End Pricing -->
                </div>
                ...
                <div class="col-sm-6 col-lg-4 mb-5">
                    ...
                    <div class="card shadow-lg h-100">
                        <!-- Header -->
                        <div class="card-header border-0 text-center mt-2">
                            <span class="d-block h2 mb-0">Paket Desain Kalender - Premium 2</span>
                        </div>
                        <!-- End Header -->
                        ...
                        <div class="card-footer border-0">
                            <a href="https://api.whatsapp.com/send?phone=6281234566636&amp;text=Halo%20GoSocial%21%0D%0ASaya%20ingin%20memesan%20layanan%20Desain%20Paket%20Desain%20Kalender%20-%20Premium%202%20Rp.%20550.000" target="_blank" type="button" class="btn btn-soft-primary btn-block transition-3d-hover font-size-2">Pesan Sekarang</a>
                        </div>
                    </div>
                    <!-- End Pricing -->
                </div>
                ...
                <div class="col-sm-6 col-lg-4 mb-5">
                    ...
                    <div class="card shadow-lg h-100">
                        <!-- Header -->
                        <div class="card-header border-0 text-center mt-2">
                            <span class="d-block h2 mb-0">Paket Desain Kalender - Premium 3</span>
                        </div>
                        <!-- End Header -->
                        ...
                        <div class="card-body">
                            <div class="mb-3 text-center">
                                <span class="h3 font-size-3 text-primary">Rp. <span class="h1 font-size-4 text-primary">750</span>.000</span>
                            </div>
                            <div class="media font-size-1 text-body mb-3 mt-5">
                                <svg style="width:24px;height:24px" viewBox="0 0 24 24" class="text-success mt-1 mr-2">
                                        <path fill="currentColor" d="M10,17L5,12L6.41,10.58L10,14.17L17.59,6.58L19,8M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z" />
                        ...
                        <div class="card-footer border-0">
                            <a href="https://api.whatsapp.com/send?phone=6281234566636&amp;text=Halo%20GoSocial%21%0D%0ASaya%20ingin%20memesan%20layanan%20Desain%20Paket%20Desain%20Kalender%20-%20Premium%203 %20Rp.%20750.000" target="_blank" type="button" class="btn btn-soft-primary btn-block transition-3d-hover font-size-2">Pesan Sekarang</a>
                        </div>
                    </div>
                    <!-- End Pricing -->
                </div>
                ...
                <div class="col-sm-6 col-lg-4 mb-5">
                    ...
                    <div class="card shadow-lg h-100">
                        <!-- Header -->
                        <div class="card-header border-0 text-center mt-2">
                            <span class="d-block h2 mb-0">Paket Desain Kalender - Premium 4</span>
                        </div>
                        <!-- End Header -->
                        ...
                        <div class="card-body">
                            <div class="mb-3 text-center">
                                <span class="h3 font-size-3 text-primary">Rp. <span class="h1 font-size-4 text-primary">1.000</span>.000</span>
                            </div>
                            <div class="media font-size-1 text-body mb-3 mt-5">
                                <svg style="width:24px;height:24px" viewBox="0 0 24 24" class="text-success mt-1 mr-2">
                                        <path fill="currentColor" d="M10,17L5,12L6.41,10.58L10,14.17L17.59,6.58L19,8M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z" />
                        ...
                        <div class="card-footer border-0">
                            <a href="https://api.whatsapp.com/send?phone=6281234566636&amp;text=Halo%20GoSocial%21%0D%0ASaya%20ingin%20memesan%20layanan%20Desain%20Paket%20Desain%20Kalender%20-%20Premium%204%20Rp.%201.000.000" target="_blank" type="button" class="btn btn-soft-primary btn-block transition-3d-hover font-size-2">Pesan Sekarang</a>
                        </div>
                    </div>
                    <!-- End Pricing -->
                </div>
