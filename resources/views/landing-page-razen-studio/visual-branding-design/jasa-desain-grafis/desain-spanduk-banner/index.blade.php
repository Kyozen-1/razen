    ...
    <div class="container-fluid">
        <div class="row">
            <div class="breadcrumbs text-center link-style-5 text-white">
                <h1 class="section-title-page text-white">Jasa Desain Spanduk & Banner</h1>
                <p class="mb-5">Layanan jasa desain spanduk & banner berkualitas dan dikerjakan oleh tim yang profesional.</p>
                <ul class="breadcrumbs-inner list-center display-flex">
                    ...
                    <li>
                        <h4 class="section-16px-regular font-weight-500 text-white">Jasa Desain Spanduk & Banner</h4>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="col-md-6">
                <div class="about-content-right wow fadeInUp" data-wow-delay="0ms"
                    ...
                    <div class="section-title">
                        <h4 class="section-subtitle">JASA DESAIN SPANDUK BANNER BALIHO</h4>
                        <h4 class="section-45px-montserrat margin-top-15 margin-bottom-20">Desain Spanduk Banner Berkualitas</h4>
                    </div>
                    <p class="section-17px-regular margin-bottom-25">
                        Spanduk dan Banner merupakan salah satu media promosi yang populer sebagai sarana menyebarkan berbagai informasi ke banyak orang. Spanduk & Banner umumnya berisikan slogan atau identitas suatu brand sebagai sebagai media iklan yang fleksibel dan tahan lama.
                        <br><br>
                        Desain Spanduk Banner Berkualitas menjadi hal yang penting untuk menampilkan identitas produk dan bisnis Anda secara kreatif dan menarik sehingga dapat meningkatkan brand awareness dengan efektif.
                        <br><br>
                        GoSocial menyediakan Jasa Desain Spanduk dan Banner untuk membantu promosi offline bisnis Anda secara efektif dan efisien.
                    </p>
                </div>
            </div>
            <div class="col-md-6">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6">
                <div class="about-content-right wow fadeInUp" data-wow-delay="0ms"
                    data-wow-duration="1500ms">
                    <div class="section-title">
                        <h4 class="section-45px-montserrat margin-top-15 margin-bottom-20">Jasa Desain Spanduk Banner Custom</h4>
                    </div>
                    <p class="section-17px-regular margin-bottom-25">
                        Desain Spanduk dan Banner yang sesuai dengan tujuan serta target dari promosi dapat meningkatkan brand awareness secara efisien. Brand awareness tinggi memungkinkan untuk meningkatkan konversi sales.
                        <br><br>
                        Jasa Desain Spanduk Banner Custom merupakan layanan yang dapat menyesuaikan desain spanduk & banner sesuai dengan identitas serta tujuan dan target dari promosi bisnis Anda.
                        <br><br>
                        Mulai tingkatkan branding bisnis anda dengan menggunakan Jasa Desain Spanduk & Banner Profesional bersama tim berpengalaman di GoSocial untuk menghasilkan desain yang kreatif dan menarik sesuai dengan kebutuhan promosi bisnis Anda.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div id="stickyBlockStartPoint" class="col-lg-5 mb-9 mb-lg-0">
                ...
                <div class="card z-index-2 p-4 p-md-7">
                    <span class="text-dark">
                        <p>Mulai dari</p>
                        <span class="display-4">Rp. 300</span>
