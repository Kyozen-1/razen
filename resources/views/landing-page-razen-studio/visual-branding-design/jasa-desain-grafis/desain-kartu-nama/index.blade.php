    ...
    <div class="container-fluid">
        <div class="row">
            <div class="breadcrumbs text-center link-style-5 text-white">
                <h1 class="section-title-page text-white">Jasa Desain Kartu Nama</h1>
                <p class="mb-5">Layanan jasa desain kartu nama berkualitas dan dikerjakan oleh tim yang profesional.</p>
                <ul class="breadcrumbs-inner list-center display-flex">
                    ...
                    <li>
                        <h4 class="section-16px-regular font-weight-500 text-white">Jasa Desain Kartu Nama</h4>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="col-md-6">
                <div class="about-content-right wow fadeInUp" data-wow-delay="0ms"
                    ...
                    <div class="section-title">
                        <h4 class="section-subtitle">JASA DESAIN KARTU NAMA #1 INDONESIA</h4>
                        <h4 class="section-45px-montserrat margin-top-15 margin-bottom-20">Kartu Nama Sebagai Branding</h4>
                    </div>
                    <p class="section-17px-regular margin-bottom-25">
                        Kartu Nama adalah salah satu alat untuk memperkenalkan diri atau usaha anda, berisi informasi data pribadi dan data perusahaan seperti nama pemilik, nama perusahaan, alamat, nomor telepon, email, situs web, dan informasi lainnya untuk perkenalan secara formal.
                        <br><br>
                        Dengan menggunakan kartu nama yang menarik maka bisnismu dapat dikenal orang lain dengan mudah. Mulai kenalkan dan branding bisnis anda dengan membuat kartu nama profesional bersama GoSocial.
                    </p>
                </div>
            </div>
            <div class="col-md-6">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6">
                <div class="about-content-right wow fadeInUp" data-wow-delay="0ms"
                    data-wow-duration="1500ms">
                    <div class="section-title">
                        <h4 class="section-45px-montserrat margin-top-15 margin-bottom-20">Jasa Desain Kartu Nama Profesional</h4>
                    </div>
                    <p class="section-17px-regular margin-bottom-25">
                        Dapatkan kartu nama dengan desain yang menarik dan profesional sesuai dengan tema bisnis anda. Dengan menggunakan Jasa Desain Kartu Nama yang profesional dan terpercaya terbukti efektif untuk meningkatkan brand value dari bisnis anda menjadi lebih profesional dan menarik.
                        <br><br>
                        Berikut adalah keuntungan memiliki sebuah Kartu Nama:
                        <br><br>
                        1. Personal branding yang eklusif dan profesional.
                        <br>
                        2. Meningkatkan kepercayaan calon konsumen & kredibilitas brand.
                        <br>
                        3. Sarana bertukar informasi antar perusahaan yang lebih formal dan profesional.
                    </p>
                </div>
            </div>
        </div>
