        ...
        <div class="container-fluid">
            <div class="row">
                <div class="breadcrumbs text-center link-style-5 text-white">
                    <h1 class="section-title-page text-white">Jasa Desain Promosi Digital</h1>
                    <p class="mb-5">Layanan jasa desain promosi digital berkualitas dan dikerjakan oleh tim yang profesional.</p>
                    <ul class="breadcrumbs-inner list-center display-flex">
                        ...
                        <li>
                            <h4 class="section-16px-regular font-weight-500 text-white">Jasa Desain Promosi Digital</h4>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="col-md-6">
                    <div class="about-content-right wow fadeInUp" data-wow-delay="0ms"
                        ...
                        <div class="section-title">
                            <h4 class="section-subtitle">BANNER IKLAN DIGITAL BERKUALITAS</h4>
                            <h4 class="section-45px-montserrat margin-top-15 margin-bottom-20">Banner Iklan Online Berkualitas</h4>
                        </div>
                        <p class="section-17px-regular margin-bottom-25">
                            Miliki banner dengan kualitas tinggi dan sesuai dengan identitas bisnis dapat memudahkan pelanggan dalam mengenal bisnis Anda sehingga memperluas jangkauan pemasaran.
                            <br><br>
                            Dengan menggunakan Jasa Desain Banner Promosi Digital Berkualitas maka kami dapat membantu untuk memenuhi kebutuhan branding dan promosi dengan tim desainer grafis profesional pilihan dari GoSocial.
                            <br><br>
                            Tingkatkan branding bisnis anda dengan Jasa Desain Promosi Digital berkualitas bersama GoSocial.
                        </p>
                    </div>
                </div>
                <div class="col-md-6">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <div class="about-content-right wow fadeInUp" data-wow-delay="0ms"
                        data-wow-duration="1500ms">
                        <div class="section-title">
                            <h4 class="section-45px-montserrat margin-top-15 margin-bottom-20">Pentingnya Desain Promosi Digital!</h4>
                        </div>
                        <p class="section-17px-regular margin-bottom-25">
                            Banner Promosi Digital merupakan salah satu media promosi paling efektif yang digunakan di dunia digital dengan tujuan untuk menjual atau hanya memperkenalkan sesuatu.
                            <br><br>
                            Dengan desain banner yang kreatif dan sesuai sasaran maka akan menarik rasa penasaran dari audience untuk meningkatkan brand awareness bisnis anda.
                            <br><br>
                            GoSocial menyediakan layanan Jasa Desain Promosi Digital untuk memenuhi kebutuhan promosi bisnis dan meningkatkan brand awareness hingga konversi sales dari bisnis anda!
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="section-title wow fadeInDown">
                        ...
                        <h2 class="section-45px-montserrat margin-top-15">Desain Promosi Digital</h2>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="section-title wow fadeInDown">
                        ...
                        <p class="text-muted">Jasa Desain Promosi Digital</p>
                    </div>
                    <div class="themesflat-spacer clearfix" data-desktop="47" data-mobile="60" data-smobile="60"
                        style="height:60px"></div>
                </div>
                ...
                <div id="stickyBlockStartPoint" class="col-lg-5 mb-9 mb-lg-0">
                    ...
                    <div class="card z-index-2 p-4 p-md-7">
                        <span class="text-dark">
                            <p>Mulai dari</p>
                            <span class="display-4">Rp. 100</span>
