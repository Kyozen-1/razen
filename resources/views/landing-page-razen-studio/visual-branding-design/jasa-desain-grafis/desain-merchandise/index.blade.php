    ...
    <div class="container-fluid">
        <div class="row">
            <div class="breadcrumbs text-center link-style-5 text-white">
                <h1 class="section-title-page text-white">Jasa Desain Merchandise</h1>
                <p class="mb-5">Layanan jasa desain merchandise nama berkualitas dan dikerjakan oleh tim yang profesional.</p>
                <ul class="breadcrumbs-inner list-center display-flex">
                    ...
                    <li>
                        <h4 class="section-16px-regular font-weight-500 text-white">Jasa Desain Merchandise</h4>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="col-md-6">
                <div class="about-content-right wow fadeInUp" data-wow-delay="0ms"
                    ...
                    <div class="section-title">
                        <h4 class="section-subtitle">PEMBUATAN DESAIN MERCHANDISE CEPAT DAN MURAH</h4>
                        <h4 class="section-45px-montserrat margin-top-15 margin-bottom-20">Desain Merchandise Custom</h4>
                    </div>
                    <p class="section-17px-regular margin-bottom-25">
                        Desain Merchandise merupakan konsep desain yang diaplikasikan ke dalam media aksesoris seperti cangkir, payung, bolpoin, dan sebagainya untuk kebutuhan branding bisnis.
                        <br><br>
                        Dengan Desain Merchandise Berkualitas dapat digunakan sebagai sarana promosi bisnis secara visual. Desain pada merchandise umumnya berisi logo, maskot, atau tulisan yang dapat menggambarkan identitas suatu bisnis secara kreatif.
                        <br><br>
                        GoSocial menyediakan Jasa Desain Merchandise Berkualitas dengan murah dan cepat untuk mendukung kebutuhan promosi bisnis Anda.
                    </p>
                </div>
            </div>
            <div class="col-md-6">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6">
                <div class="about-content-right wow fadeInUp" data-wow-delay="0ms"
                    data-wow-duration="1500ms">
                    <div class="section-title">
                        <h4 class="section-45px-montserrat margin-top-15 margin-bottom-20">Manfaat Desain Merchandise</h4>
                    </div>
                    <p class="section-17px-regular margin-bottom-25">
                        GoSocial menyediakan layanan desain berbagai merchandise seperti desain mug, desain payung, desain bolpoin, desain jam, dan sebagainya untuk meningkatkan branding hingga konversi sales dari bisnis Anda.
                        <br><br>
                        Berikut adalah keuntungan memiliki Desain Merchandise Profesional:
                        <br><br>
                        1. Media efektif meningkatkan branding bisnis yang profesional
                        <br>
                        2. Memperkuat relasi secara profesional dengan partner bisnis
                        <br>
                        3. Bentuk apresiasi kepada konsumen yang loyal
                        <br>
                        4. Menjangkau target audiens dengan mudah dan lebih luas
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="section-title wow fadeInDown">
                    ...
                    <h2 class="section-45px-montserrat margin-top-15">Desain Merchandise</h2>
                </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="section-title wow fadeInDown">
                    ...
                    <p class="text-muted">Jasa Desain Merchandise</p>
                </div>
                <div class="themesflat-spacer clearfix" data-desktop="47" data-mobile="60" data-smobile="60"
                    style="height:60px"></div>
            </div>
