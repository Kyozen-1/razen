    ...
    <div class="container-fluid">
        <div class="row">
            <div class="breadcrumbs text-center link-style-5 text-white">
                <h1 class="section-title-page text-white">Jasa Desain Brosur</h1>
                <p class="mb-5">Layanan jasa desain brosur nama berkualitas dan dikerjakan oleh tim yang profesional.</p>
                <ul class="breadcrumbs-inner list-center display-flex">
                    ...
                    <li>
                        <h4 class="section-16px-regular font-weight-500 text-white">Jasa Desain Brosur</h4>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="col-md-6">
                <div class="about-content-right wow fadeInUp" data-wow-delay="0ms"
                    ...
                    <div class="section-title">
                        <h4 class="section-subtitle">JASA DESAIN BROSUR #1 INDONESIA</h4>
                        <h4 class="section-45px-montserrat margin-top-15 margin-bottom-20">Desain Brosur Online Berkualitas</h4>
                    </div>
                    <p class="section-17px-regular margin-bottom-25">
                        Brosur menjadi salah satu media marketing yang efektif untuk memberikan dan menyampaikan informasi kepada calon customer. Jadikan bisnis anda stand out diantara kompetitor lainnya dengan brosur yang menarik, kreatif, dan profesional.
                        <br><br>
                        Desain Brosur yang profesional akan menarik minat calon customer untuk membaca dan mengetahui lebih lanjut tentang produk dan bisnis yang anda tawarkan.
                        <br> <br>
                        Temukan Desain Brosur Online Berkualitas untuk segala kebutuhan seperti desain brosur properti, desain brosur perusahaan, dan desain brosur lainnya di GoSocial.
                    </p>
                </div>
            </div>
            <div class="col-md-6">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6">
                <div class="about-content-right wow fadeInUp" data-wow-delay="0ms"
                    data-wow-duration="1500ms">
                    <div class="section-title">
                        <h4 class="section-45px-montserrat margin-top-15 margin-bottom-20">Jasa Desain Brosur Profesional</h4>
                    </div>
                    <p class="section-17px-regular margin-bottom-25">
                        GoSocial menyediakan layanan Jasa Desain Brosur Berkualitas untuk memenuhi kebutuhan promosi bisnis dan meningkatkan brand awareness hingga konversi sales dari bisnis Anda.
                        <br><br>
                        Pemasaran yang efektif tidak terbatas pada media digital saja. Desain Brosur yang profesional dan sesuai dengan identitas bisnis akan mempermudah Anda untuk mempersiapkan kebutuhan promosi offline sehingga hasil akan menjadi lebih maksimal dan konversi akan meningkat secara efektif serta efisien.
                        <br> <br>
                        Mulai tingkatkan branding bisnis anda dengan menggunakan Jasa Desain Brosur Profesional bersama tim berpengalaman di GoSocial.
                    </p>
                </div>
            </div>
        </div>
