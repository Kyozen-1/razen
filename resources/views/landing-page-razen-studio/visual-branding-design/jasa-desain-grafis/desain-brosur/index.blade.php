...
@section('title', $desain_brosur_section_1['title'])
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="breadcrumbs text-center link-style-5 text-white">
                <h1 class="section-title-page text-white">{{$desain_brosur_section_1['judul']}}</h1>
                <p class="mb-5">{{$desain_brosur_section_1['deskripsi']}}</p>
                <ul class="breadcrumbs-inner list-center display-flex">
                    ...
                    <li>
                        <h4 class="section-16px-regular font-weight-500 text-white">{{$desain_brosur_section_1['judul']}}</h4>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="col-md-6">
                <div class="about-content-right wow fadeInUp" data-wow-delay="0ms"
                    ...
                    <div class="section-title">
                        <h4 class="section-subtitle">{{$desain_brosur_section_2['sub_judul']}}</h4>
                        <h4 class="section-45px-montserrat margin-top-15 margin-bottom-20">{{$desain_brosur_section_2['judul']}}</h4>
                    </div>
                    <p class="section-17px-regular margin-bottom-25">
                        {!! $desain_brosur_section_2['deskripsi'] !!}
                    </p>
                </div>
            </div>
            <div class="col-md-6">
                <div class="about-content-left wow fadeInLeft">
                    <div class="about-post">
                        <img src="{{ asset('images/landingpage_razenstudio/visual-branding-design/jasa-desain-grafis/desain-brosur/'.$desain_brosur_section_2['gambar']) }}" alt="images">
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="about-content-left wow fadeInLeft">
                    <div class="about-post">
                        <img src="{{ asset('images/landingpage_razenstudio/visual-branding-design/jasa-desain-grafis/desain-brosur/'.$desain_brosur_section_3['gambar']) }}" alt="images">
                        <div class="mark-about-post"></div>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="about-content-right wow fadeInUp" data-wow-delay="0ms"
                    data-wow-duration="1500ms">
                    <div class="section-title">
                        <h4 class="section-45px-montserrat margin-top-15 margin-bottom-20">{{$desain_brosur_section_3['judul']}}</h4>
                    </div>
                    <p class="section-17px-regular margin-bottom-25">
                        {!!$desain_brosur_section_3['deskripsi']!!}
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="card bg-danger text-white overflow-hidden p-5">
                <div class="row justify-content-md-start align-items-md-center text-center text-md-left">
                    <div class="col-md-6 offset-md-3 mb-3 mb-md-0">
                        <h3 class="text-white font-size-2 mb-1">{{$desain_brosur_section_4['judul']}}</h3>
                        <p class="text-white-70 font-size-2 mb-0">{{$desain_brosur_section_4['deskripsi']}}</p>
                    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="section-title wow fadeInDown">
                    <h4 class="section-subtitle">{{$desain_brosur_section_5['sub_judul']}}</h4>
                    <h2 class="section-45px-montserrat margin-top-15">{{$desain_brosur_section_5['judul']}}</h2>
                </div>
...
<section class="flat-services">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="section-title wow fadeInDown">
                    <h4 class="section-45px-montserrat margin-top-15">{{$desain_brosur_section_6['judul']}}</h4>
                    <p class="text-muted">{{$desain_brosur_section_6['deskripsi']}}</p>
                </div>
                <div class="themesflat-spacer clearfix" data-desktop="47" data-mobile="60" data-smobile="60"
                    style="height:60px"></div>
            </div>
        ...
        <div class="row align-items-lg-center">
            @php
                ...
                foreach ($desain_brosur_section_6['item'] as $value) {
                ...
                <div class="pl-lg-6">
                    <div class="row">
                        <div class="col-sm-6 mb-3">
                            <!-- Icon Blocks -->
                            <figure class="mb-3">
                                <img style="width: 7rem; height:auto;" src="{{ asset('images/landingpage_razenstudio/visual-branding-design/jasa-desain-grafis/desain-brosur/'.$item_2['ikon']) }}" alt="SVG">
                            </figure>
                            <h3>{{$item_2['judul']}}</h3>
                    ...
                    <div class="row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            <!-- Icon Blocks -->
                            <figure class="mb-3">
                                <img style="width: 7rem; height:auto;" src="{{ asset('images/landingpage_razenstudio/visual-branding-design/jasa-desain-grafis/desain-brosur/'.$item_3['ikon']) }}" alt="SVG">
                            </figure>
                            <h3>{{$item_4['judul']}}</h3>
                        ...
                        <div class="col-sm-6">
                            <!-- Icon Blocks -->
                            <figure class="mb-3">
                                <img style="width: 7rem; height:auto;" src="{{ asset('images/landingpage_razenstudio/visual-branding-design/jasa-desain-grafis/desain-brosur/'.$item_4['ikon']) }}" alt="SVG">
                            </figure>
                            <h3>{{$item_5['judul']}}</h3>
                            <p>{{$item_5['deskripsi']}}
                            </p>
...
<section class="flat-counter">
    <div class="container">
        <div class="row mb-5">
            <div class="col-md-12">
                <div class="section-title wow fadeInDown">
                    <h4 class="section-subtitle">{{$desain_brosur_section_7['sub_judul']}}</h4>
                    <h2 class="section-main-title section-45px-montserrat">{{$desain_brosur_section_7['judul']}}</h2>
                </div>
            </div>
        </div>
        <div class="row">
                    ...
                    <div class="counter-box themesflat-counter hover-up wow fadeInUp" data-wow-delay="0.1s">
                        <div class="icon-box">
                            <div class="icon-counter">
                                <img style="height: 5rem; width:5rem; padding: -3rem;" src="{{ asset('images/landingpage_razenstudio/visual-branding-design/jasa-desain-grafis/desain-brosur/'.$item['gambar_konten']) }}">
                            </div>
                        </div>
...
<section class="flat-services">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="section-title wow fadeInDown">
                    <h4 class="section-subtitle">{{$desain_brosur_section_8['sub_judul']}}</h4>
                    <h2 class="section-45px-montserrat margin-top-15">{{$desain_brosur_section_8['judul']}}</h2>
                </div>
                <div class="themesflat-spacer clearfix" data-desktop="47" data-mobile="60" data-smobile="60"
                    style="height:60px"></div>
            </div>
