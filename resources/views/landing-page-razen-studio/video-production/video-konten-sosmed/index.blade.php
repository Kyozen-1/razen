    ...
    <div class="container-fluid">
        <div class="row">
            <div class="breadcrumbs text-center link-style-5 text-white">
                <h1 class="section-title-page text-white">Jasa Video Promosi Social Media</h1>
                <p class="mb-5">Pembuatan Video Promosi untuk Konten Social Media (Instagram Reels, TikTok, Youtube, dsb).</p>
                <ul class="breadcrumbs-inner list-center display-flex">
                    ...
                    <li>
                        <h4 class="section-16px-regular font-weight-500 text-white">Jasa Video Promosi Social Media</h4>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="col-md-6">
                <div class="about-content-right wow fadeInUp" data-wow-delay="0ms"
                    ...
                    <div class="section-title">
                        <h4 class="section-subtitle">VIDEO MARKETING</h4>
                        <h4 class="section-45px-montserrat margin-top-15 margin-bottom-20">Pentingnya Konten Video di Social Media!</h4>
                    </div>
                    <p class="section-17px-regular margin-bottom-25">
                        Salah satu format konten yang terbukti ampuh menarik minat calon konsumen melalui media sosial adalah video, atau biasa disebut sebagai video marketing.
                        <br><br>
                        Menurut ourworldindata.org dalam beberapa tahun terakhir jumlah views video pada media sosial meningkat tajam. Seperti pada YouTube, jumlah penonton video konten bersponsor meningkat sampai 99%, sementara jumlah views di Facebook naik 258%.
                    </p>
                </div>
            </div>
            <div class="col-md-6">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6">
                <div class="about-content-right wow fadeInUp" data-wow-delay="0ms"
                    data-wow-duration="1500ms">
                    <div class="section-title">
                        <h4 class="section-45px-montserrat margin-top-15 margin-bottom-20">Jasa Video Marketing</h4>
                    </div>
                    <p class="section-17px-regular margin-bottom-25">
                        Namun setiap media sosial punya karakteristik masing-masing, untuk bisa mencapai kampanye video yang optimal. Maka dari itu, perlu diidentifikasi terlebih dahulu, apa keunggulan dan strategi konten video di tiap channel, agar effort dan biaya yang dikeluarkan tidak sia-sia.
                        <br><br>
                        Jasa Video Sosmed dari GoSocial dapat membantu bisnis dalam:
                        <br><br>
                        1. Membuat konsep video campaign di Social Media.
                        <br>
                        2. Mempublikasikan video di Instagram Reels, TikTok, maupun Youtube.
                    </p>
                </div>
            </div>
        </div>
            ...
            <li class="step-item">
                <div class="step-content-wrapper">
                    ...
                    <div class="step-content">
                        ...
                        <p>Mulai pembuatan konsep video campaign video.</p>
                    </div>
                </div>
            </li>
        ...
        <div class="row">
            <div class="col-4 my-3">
                <a class="card text-body transition-3d-hover js-fancybox" href="javascript:;" data-hs-fancybox-options="{
                    ...
                    <img class="card-img-top" src="https://gosocial.co.id/assets/img/service/video/sosmed/portofolio/youtube-1.webp" alt="Image Description">
            ...
            <div class="col-4 my-3">
                <a class="card text-body transition-3d-hover js-fancybox" href="javascript:;" data-hs-fancybox-options="{
                    &quot;src&quot;: &quot;//youtube.com/YHxGlMC9aak&quot;,
                    &quot;caption&quot;: &quot;Tutorial Crypto Staking di Triv untuk Pendapatan Tambahan | TRIV INDONESIA&quot;,
                    &quot;speed&quot;: 700,
                    &quot;buttons&quot;: [&quot;fullScreen&quot;, &quot;close&quot;],
                    &quot;vimeo&quot;: {
                        &quot;autoplay&quot;: 1
                    ...
                    <img class="card-img-top" src="https://gosocial.co.id/assets/img/service/video/sosmed/portofolio/portof-1.webp" alt="Image Description">
                    <div class="card-body text-center">
                        <h2 class="text-dark">Weekly Updates</h2>
                    </div>
                </a>
            </div>
            <div class="col-4 my-3">
                <a class="card text-body transition-3d-hover js-fancybox" href="javascript:;" data-hs-fancybox-options="{
                    &quot;src&quot;: &quot;//youtu.be/Lt8EX3g_Jvw&quot;,
                    &quot;caption&quot;: &quot;Preview Aplikasi Triv | Triv Indonesia&quot;,
                    &quot;speed&quot;: 700,
                    &quot;buttons&quot;: [&quot;fullScreen&quot;, &quot;close&quot;],
                    &quot;vimeo&quot;: {
                        &quot;autoplay&quot;: 1
                    ...
                    <img class="card-img-top" src="https://gosocial.co.id/assets/img/service/video/sosmed/portofolio/youtube-2.webp" alt="Image Description">
                    <div class="card-body text-center">
                        <h2 class="text-dark">Konten Marketing</h2>
                    </div>
                </a>
            </div>
        </div>
