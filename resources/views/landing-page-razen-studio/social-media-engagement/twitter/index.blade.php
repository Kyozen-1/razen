@php
    ...
    $twitter_section1 = json_decode($twitter->section_1, true);
    $twitter_section2 = json_decode($twitter->section_2, true);
    $twitter_section3 = json_decode($twitter->section_3, true);
    $twitter_section4 = json_decode($twitter->section_4, true);
    $twitter_section5 = json_decode($twitter->section_5, true);
    $twitter_section6 = json_decode($twitter->section_6, true);
    $twitter_section7 = json_decode($twitter->section_7, true);
...
@section('title', $twitter_section1['title'])
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="breadcrumbs text-center link-style-5 text-white">
                <h1 class="section-title-page text-white">{{$twitter_section1['judul']}}</h1>
                ...
                <ul class="breadcrumbs-inner list-center display-flex">
                    ...
                    <li>
                        <h4 class="section-16px-regular font-weight-500 text-white">{{$twitter_section1['judul']}}</h4>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container position-relative z-index-2 space-lg-2 space-1 mb-lg-5 mb-2">
            ...
            <div class="col-lg-6">
                <div class="position-relative ">
                    <div id="youTubeVideoPlayerExample2" class="video-player">
                        <!-- Thumbnail -->
                        <img class="img-fluid video-player-preview rounded-lg" src="{{ asset('images/landingpage_razenstudio/social-media-engagement/twitter/'.$twitter_section2['gambar']) }}" alt="Beli Followers Instagram">
                        <!-- END Thumbnail -->
                        <!-- Video Iframe -->
        ...
        <div class="row justify-content-center  text-white">
            <div class="col-lg-8 text-center">
                <h2 class="mb-3 text-white">{{$twitter_section2['judul']}}</h2>
                <p>{!! $twitter_section2['deskripsi'] !!}</p>
            ...
            <div class="col-md-6">
                <div class="about-content-left wow fadeInLeft">
                    <div class="about-post">
                        <img src="{{ asset('images/landingpage_razenstudio/social-media-engagement/twitter/'.$twitter_section3['gambar']) }}" alt="images">
            ...
            <div class="col-md-6">
                <div class="about-content-right wow fadeInUp" data-wow-delay="0ms"
                    ...
                    <div class="section-title">
                        <h4 class="section-45px-montserrat margin-top-15 margin-bottom-20">{{$twitter_section3['judul']}}</h4>
                    </div>
                    <p class="section-17px-regular margin-bottom-25">
                        {!! $twitter_section3['deskripsi'] !!}
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="about-content-right wow fadeInUp" data-wow-delay="0ms"
                    data-wow-duration="1500ms">
                    <div class="section-title">
                        <h4 class="section-45px-montserrat margin-top-15 margin-bottom-20">{{$twitter_section4['judul']}}</h4>
                    </div>
                    <p class="section-17px-regular margin-bottom-25">
                        {!! $twitter_section4['deskripsi'] !!}
                    </p>
                </div>
            </div>
            <div class="col-md-6">
                <div class="about-content-left wow fadeInLeft">
                    <div class="about-post">
                        <img src="{{ asset('images/landingpage_razenstudio/social-media-engagement/twitter/'.$twitter_section4['gambar']) }}" alt="images">
                        <div class="mark-about-post"></div>
                    </div>
                </div>
            </div>
        ...
        <div class="card bg-danger text-white overflow-hidden p-4">
            ...
            <div class="row justify-content-md-start align-items-md-center text-center text-md-left">
                <div class="col-md-6 offset-md-3 mb-3 mb-md-0">
                    <h2 class="text-white mb-1">{{$twitter_section5['judul']}}</h2>
                    <p class="text-white-70 mb-0 font-size-2">{{$twitter_section5['deskripsi']}}</p>
                </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="section-title wow fadeInDown">
                    <h2 class="section-45px-montserrat margin-top-15">{{$twitter_section6['judul']}}</h2>
                </div>
        ...
        <ul class="step step-md step-centered">
            @php
                $i = 1;
            @endphp
            @foreach ($twitter_section6['konten'] as $item)
            <li class="step-item">
        ...
        <div class="overflow-hidden space-top-lg-2">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="section-title wow fadeInDown">
                            <h4 class="section-subtitle">{{$twitter_section7['sub_judul']}}</h4>
                            <h2 class="section-45px-montserrat margin-top-15">{{$twitter_section7['judul']}}</h2>
                        </div>
                        <div class="themesflat-spacer clearfix" data-desktop="47" data-mobile="60" data-smobile="60"
                            style="height:60px"></div>
                    </div>
