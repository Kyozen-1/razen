    ...
    <div class="container-fluid">
        <div class="row">
            <div class="breadcrumbs text-center link-style-5 text-white">
                <h1 class="section-title-page text-white">Facebook - SME Services</h1>
                ...
                <ul class="breadcrumbs-inner list-center display-flex">
                    ...
                    <li>
                        <h4 class="section-16px-regular font-weight-500 text-white">Facebook - SME Services</h4>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="col-md-6">
                <div class="about-content-right wow fadeInUp" data-wow-delay="0ms"
                    ...
                    <div class="section-title">
                        <h4 class="section-45px-montserrat margin-top-15 margin-bottom-20">Auto Likes Facebook</h4>
                    </div>
                    <p class="section-17px-regular margin-bottom-25">
                        GoSocial menyediakan Autolike FB, untuk menunjang keberhasilan konten di Facebook. Layanan ini akan menambahkan likes secara otomatis setelah melakukan update post di Facebook yang dapat digunakan untuk Fanpage maupun akun pribadi.
                        <br>
                        Dengan memiliki jumlah likes yang banyak di suatu posting Facebook maka akan meningkatkan kredibilitas akun dan juga meningkatkan kesempatan untuk memperluas jangkauan post kepada audience baru karena dinilai lebih populer oleh algoritma Facebook.
                    </p>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="section-title wow fadeInDown">
                            ...
                            <h2 class="section-45px-montserrat margin-top-15">Paket Harga SME Facebook</h2>
                        </div>
                        <div class="themesflat-spacer clearfix" data-desktop="47" data-mobile="60" data-smobile="60"
                            style="height:60px"></div>
                    </div>
