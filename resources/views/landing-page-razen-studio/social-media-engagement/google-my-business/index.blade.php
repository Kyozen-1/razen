    ...
    <div class="container-fluid">
        <div class="row">
            <div class="breadcrumbs text-center link-style-5 text-white">
                <h1 class="section-title-page text-white">Google - SME Services</h1>
                ...
                <ul class="breadcrumbs-inner list-center display-flex">
                    ...
                    <li>
                        <h4 class="section-16px-regular font-weight-500 text-white">Google - SME Services</h4>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="col-md-6">
                <div class="about-content-right wow fadeInUp" data-wow-delay="0ms"
                    ...
                    <div class="section-title">
                        <h4 class="section-45px-montserrat margin-top-15 margin-bottom-20">Jasa Review Google</h4>
                    </div>
                    <p class="section-17px-regular margin-bottom-25">
                        GoSocial menyediakan Jasa Review / Ulasan untuk Google My Business & Google Maps, berasal dari akun pengguna Google Indonesia yang aktif sebagai kontributor.
                        <br>
                        Semakin banyak review yang dimiliki oleh suatu bisnis di Google maka akan meningkatkan ranking di listing Google My Business sehingga akan meningkatkan traffic organik.
                        <br>
                        Layanan ini dibuat khusus untuk bisnis dalam meningkatkan kredibilitas serta ranking di halaman pencarian Local SEO / Google
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="about-content-right wow fadeInUp" data-wow-delay="0ms"
                    data-wow-duration="1500ms">
                    <div class="section-title">
                        <h4 class="section-45px-montserrat margin-top-15 margin-bottom-20">Jasa Review Google Maps</h4>
                    </div>
                    <p class="section-17px-regular margin-bottom-25">
                        Jasa Review Google Maps merupakan layanan untuk meningkatkan ratting atau ulasan tempat di peta google dan merupakan cara terbaru dalam mendapatkan review melalui pengguna asli google yang aman dan tidak terdeteksi, dan dapat meningkatkan rangking di pencarian SEO sehingga berkesempatan mendapatkan lebih banyak views dan pengunjung ke bisnis.
                    </p>
                </div>
            </div>
            <div class="col-md-6">
        ...
        <div class="card bg-danger text-white overflow-hidden p-4">
            ...
            <div class="row justify-content-md-start align-items-md-center text-center text-md-left">
                <div class="col-md-6 offset-md-3 mb-3 mb-md-0">
                    ...
                    <p class="text-white-70 mb-0 font-size-2">Beragam layanan interaksi untuk menunjang eksistensi branding bisnis & performa di Google tersedia disini.</p>
                </div>
...
<div class="container space-2">
    <div class="row align-items-lg-center">
        <div class="col-lg-6 mb-7 mb-lg-0">
            <div class="mb-5">
                <h2 class="mb-3">Keuntungan memiliki banyak ulasan positif di Google My Business.</h2>
                <p>Banyak sekali keuntungan yang akan didapat ketika bisnis memiliki review/ulasan yang banyak dan positif di Google, diantaranya:</p>
            </div>
            ...
            <div class="media pb-3">
                ...
                <div class="media-body">
                    <p class="text-dark mb-0">Meningkatkan visibilitas bisnis di Google Maps ke jangkauan yang lebih luas (Di kota lain / provinsi lain)</p>
                </div>
            </div>
            <div class="media py-3">
                ...
                <div class="media-body">
                    <p class="text-dark mb-0">Meningkatkan kredibilitas bisnis di dunia digital</p>
                </div>
            </div>
            <div class="media pt-3">
                ...
                <div class="media-body">
                    <p class="text-dark mb-0">Membantu meningkatkan SEO untuk traffic website</p>
                </div>
            </div>
            <!-- End Info -->
        </div>
