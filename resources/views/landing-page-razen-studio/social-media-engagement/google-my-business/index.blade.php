@php
    ...
    $google_my_business_section1 = json_decode($google_my_business->section_1, true);
    $google_my_business_section2 = json_decode($google_my_business->section_2, true);
    $google_my_business_section3 = json_decode($google_my_business->section_3, true);
    $google_my_business_section4 = json_decode($google_my_business->section_4, true);
    $google_my_business_section5 = json_decode($google_my_business->section_5, true);
    $google_my_business_section6 = json_decode($google_my_business->section_6, true);
    $google_my_business_section7 = json_decode($google_my_business->section_7, true);
    $google_my_business_section8 = json_decode($google_my_business->section_8, true);

    $reviews = LandingpageRazenstudioReview::latest()->get();
    $partners = LandingpageRazenstudioOfficialPartner::all();
@endphp
@extends('landing-page-razen-studio.layouts.app')
@section('title', $google_my_business_section1['title'])
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="breadcrumbs text-center link-style-5 text-white">
                <h1 class="section-title-page text-white">{{$google_my_business_section1['judul']}}</h1>
                <p class="mb-5">{{$google_my_business_section1['deskripsi']}}</p>
                <ul class="breadcrumbs-inner list-center display-flex">
                    ...
                    <li>
                        <h4 class="section-16px-regular font-weight-500 text-white">{{$google_my_business_section1['judul']}}</h4>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container position-relative z-index-2 space-lg-2 space-1 mb-lg-5 mb-2">
            ...
            <div class="col-lg-6">
                <div class="position-relative ">
                    <div id="youTubeVideoPlayerExample2" class="video-player">
                        <!-- Thumbnail -->
                        <img class="img-fluid video-player-preview rounded-lg" src="{{ asset('images/landingpage_razenstudio/social-media-engagement/google-my-business/'.$google_my_business_section2['gambar']) }}" alt="Beli Followers Instagram">
                        <!-- END Thumbnail -->
                        <!-- Video Iframe -->
        ...
        <div class="row justify-content-center  text-white">
            <div class="col-lg-8 text-center">
                <h2 class="mb-3 text-white">{{$google_my_business_section2['judul']}}</h2>
                <p>{!!$google_my_business_section2['deskripsi']!!}</p>
            ...
            <div class="col-md-6">
                <div class="about-content-left wow fadeInLeft">
                    <div class="about-post">
                        <img src="{{ asset('images/landingpage_razenstudio/social-media-engagement/google-my-business/'.$google_my_business_section3['gambar']) }}" alt="images">
            ...
            <div class="col-md-6">
                <div class="about-content-right wow fadeInUp" data-wow-delay="0ms"
                    ...
                    <div class="section-title">
                        <h4 class="section-45px-montserrat margin-top-15 margin-bottom-20">{{$google_my_business_section3['judul']}}</h4>
                    </div>
                    <p class="section-17px-regular margin-bottom-25">
                        {!! $google_my_business_section3['deskripsi'] !!}
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="about-content-right wow fadeInUp" data-wow-delay="0ms"
                    data-wow-duration="1500ms">
                    <div class="section-title">
                        <h4 class="section-45px-montserrat margin-top-15 margin-bottom-20">{{$google_my_business_section4['judul']}}</h4>
                    </div>
                    <p class="section-17px-regular margin-bottom-25">
                        {!! $google_my_business_section4['deskripsi'] !!}
                    </p>
                </div>
            </div>
            <div class="col-md-6">
                <div class="about-content-left wow fadeInLeft">
                    <div class="about-post">
                        <img src="{{ asset('images/landingpage_razenstudio/social-media-engagement/google-my-business/'.$google_my_business_section4['gambar']) }}" alt="images">
                        <div class="mark-about-post"></div>
                    </div>
                </div>
            </div>
        ...
        <div class="card bg-danger text-white overflow-hidden p-4">
            ...
            <div class="row justify-content-md-start align-items-md-center text-center text-md-left">
                <div class="col-md-6 offset-md-3 mb-3 mb-md-0">
                    <h2 class="text-white mb-1">{{$google_my_business_section5['judul']}}</h2>
                    <p class="text-white-70 mb-0 font-size-2">{{$google_my_business_section5['deskripsi']}}</p>
                </div>
...
<div class="container space-2">
    <div class="row align-items-lg-center">
        <div class="col-lg-6 mb-7 mb-lg-0">
            <div class="mb-5">
                <h2 class="mb-3">{{$google_my_business_section6['judul']}}</h2>
                <p>{!! $google_my_business_section6['deskripsi'] !!}</p>
            </div>
        </div>
        ...
        <div class="col-lg-6">
            ...
            <div class="pl-lg-4">
                <div class="card shadow-none bg-soft-primary text-indigo text-center w-lg-100 overflow-hidden pt-9 px-5">
                    <div class="px-5 mb-5">
                        <h3>Investasi 1x untuk bangun value di Google My Business</h3>
                    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="section-title wow fadeInDown">
                    <h2 class="section-45px-montserrat margin-top-15">{{$google_my_business_section7['judul']}}</h2>
                </div>
        ...
        <ul class="step step-md step-centered">
            @php
                $i = 1;
            @endphp
            @foreach ($google_my_business_section7['konten'] as $item)
                <li class="step-item">
