...
@section('title', 'Jasa Tambah Followers, Auto Likes, Views #1 di Youtube - Razen Studio')
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="breadcrumbs text-center link-style-5 text-white">
                <h1 class="section-title-page text-white">Youtube - SME Services</h1>
                <p class="mb-5">Solusi untuk meningkatkan interaksi pada akun Youtube.</p>
                <ul class="breadcrumbs-inner list-center display-flex">
                    ...
                    <li>
                        <h4 class="section-16px-regular font-weight-500 text-white">Youtube - SME Services</h4>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="card bg-danger text-white overflow-hidden p-4">
            ...
            <div class="row justify-content-md-start align-items-md-center text-center text-md-left">
                <div class="col-md-6 offset-md-3 mb-3 mb-md-0">
                    ...
                    <p class="text-white-70 mb-0 font-size-2">Beragam layanan interaksi untuk menunjang eksistensi branding bisnis & performa digital tersedia disini.</p>
                </div>
    ...
    <div class="container space-bottom-3">
        <div class="row align-items-lg-center ">
            <div class="col-lg-6 order-lg-2 mb-7 mb-lg-0">
                <div class="mb-5">
                    <h3 class="h2 mb-3">Keuntungan Memiliki Banyak Subscribers &amp; Interaksi di Youtube</h3>
                    <p>Meskipun membeli subscribers dan juga views Youtube tidak berarti menjadikannya pengguna yang akan selalu menonton dan berinteraksi sehingga terkesan tidak berguna, namun sebenarnya ada banyak sekali keuntungan yang bisa didapatkan, yaitu:</p>
                </div>
                ...
                <div class="media pb-2">
                    ...
                    <div class="media-body">
                        <p class="text-dark mb-0">Membuat channel Youtube lebih kredibel</p>
                    </div>
                </div>
                <div class="media py-2">
                    ...
                    <div class="media-body">
                        <p class="text-dark mb-0">Melengkapi syarat monetize channel (Adsense)</p>
                    </div>
                </div>
                <div class="media py-2">
                    <span class="mr-3">
                    ...
                    <div class="media-body">
                        <p class="text-dark mb-0">Meningkatkan ranking &amp; visibilitas video di pencarian Youtube (SEO)</p>
                    </div>
                </div>
                <div class="media pt-2">
                    ...
                    <div class="media-body">
                        <p class="text-dark mb-0">Membantu menarik engagement dan subscribers baru secara organik</p>
                    </div>
                </div>
                <!-- End Info -->
            </div>
