...
@section('title', 'Jasa Tambah Followers, Auto Likes, Views #1 di Tik Tok - Razen Studio')
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="breadcrumbs text-center link-style-5 text-white">
                <h1 class="section-title-page text-white">TikTok - SME Services</h1>
                <p class="mb-5">Solusi untuk meningkatkan interaksi pada akun TikTok</p>
                <ul class="breadcrumbs-inner list-center display-flex">
                    ...
                    <li>
                        <h4 class="section-16px-regular font-weight-500 text-white">TikTok - SME Services</h4>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container position-relative z-index-2 space-lg-2 space-1 mb-lg-5 mb-2">
        ...
        <div class="row justify-content-center  text-white">
            <div class="col-lg-8 text-center">
                <h2 class="mb-3 text-white">Apa itu Engagement Rate TikTok?/h2>
                <p><b>Engagement Rate TikTok</b> adalah skor interaksi yang dimiliki pada suatu akun TikTok. Semakin tinggi ER yang dimiliki maka bisa diartikan akun tersebut cukup populer. Engagement di TikTok dapat berupa jumlah views, likes, komentar, dan repost.</p>
                ...
                <p class="mt-3 small">*GoSocial menyediakan layanan ekslusif untuk meningkatkan interaksi TikTok dan berbagai platform digital lainnya.</p>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-6">
                <div class="about-content-right wow fadeInUp" data-wow-delay="0ms"
                    ...
                    <div class="section-title">
                        <h4 class="section-45px-montserrat margin-top-15 margin-bottom-20">Beli Followers TikTok</h4>
                    </div>
                    <p class="section-17px-regular margin-bottom-25">
                        GoSocial menyediakan Jasa Followers TikTok untuk menambah jumlah Followers/pengikut pada akun TikTok, berasal dari akun yang dibuat dan dikelola menyerupai akun aktif pengguna TikTok Indonesia.
                        <br>
                        Jumlah Followers yang banyak dapat meningkatkan reputasi, kredibilitas serta popularitas suatu brand di TikTok.
                        <br>
                        Layanan ini dibuat khusus untuk bisnis dalam meningkatkan kredibilitas digital yang sering disebut dengan Jasa Tambah / Beli Followers Tiktok.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="about-content-right wow fadeInUp" data-wow-delay="0ms"
                    data-wow-duration="1500ms">
                    <div class="section-title">
                        <h4 class="section-45px-montserrat margin-top-15 margin-bottom-20">Auto Likes & Auto View TikTok</h4>
                    </div>
                    <p class="section-17px-regular margin-bottom-25">Merupakan layanan untuk menambah jumlah likes dan view pada konten TikTok yang dapat meningkatkan performa konten serta bisa meningkatkan peluang menjadi FYP (For Your Page) di Tiktok.
                        <br>
                        Bisnis Anda sudah buat konten susah-susah namun tidak ada interaksi yang berarti? belum pernah FYP?
                        <br>
                        Layanan ini sangat cocok untuk meningkatkan peluang bersaing dengan konten lain sekaligus meningkatkan trust dari audience lainnya.</p>
                </div>
            </div>
            <div class="col-md-6">
                <div class="about-content-left wow fadeInLeft">
        ...
        <div class="card bg-danger text-white overflow-hidden p-4">
            ...
            <div class="row justify-content-md-start align-items-md-center text-center text-md-left">
                <div class="col-md-6 offset-md-3 mb-3 mb-md-0">
                    <h2 class="text-white mb-1">Berbagai layanan lainnya untuk TikTok</h2>
                    <p class="text-white-70 mb-0 font-size-2">Beragam layanan interaksi untuk meningkatkan branding bisnis & performa TikTok tersedia disini.</p>
                </div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6">
                <div class="about-content-right wow fadeInUp" data-wow-delay="0ms"
                    data-wow-duration="1500ms">
                    <div class="section-title">
                        <h4 class="section-45px-montserrat margin-top-15 margin-bottom-20">Keuntungan Memiliki Banyak Interaksi di TikTok</h4>
                    </div>
                    <p class="section-17px-regular margin-bottom-25">Membeli followers, likes maupun views di TikTok bukan berarti setiap posting akan menjadi FYP ataupun viral dan juga tidak berarti menjadikannya pembeli sehingga terkesan tidak berguna, namun sebenarnya ada banyak sekali keuntungan yang bisa didapatkan oleh bisnis, yaitu:</p>
                    <ul>
                        <li><p>1. Membuat bisnis/akun lebih terpercaya.</p></li>
                        <li><p>2. Meningkatkan visibilitas konten di pencarian TikTok yang dapat menyebabkan FYP.</p></li>
                        <li><p>3. Membantu menarik engagement dan followers baru secara organik.</p></li>
                    </ul>
                </div>
            </div>
        </div>
