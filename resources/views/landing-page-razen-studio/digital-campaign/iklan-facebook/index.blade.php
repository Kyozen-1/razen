    ...
    <div class="container-fluid">
        <div class="row">
            <div class="breadcrumbs text-center link-style-5 text-white">
                <h1 class="section-title-page text-white">Jasa Iklan Facebook</h1>
                <p class="mb-5">Solusi pembuatan dan pengelolaan campaign Facebook Ads untuk meningkatkan penjualan serta branding bisnis secara online.</p>
                <ul class="breadcrumbs-inner list-center display-flex">
                    ...
                    <li>
                        <h4 class="section-16px-regular font-weight-500 text-white">Jasa Iklan Facebook</h4>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="col-md-6">
                <div class="about-content-right wow fadeInUp" data-wow-delay="0ms"
                    ...
                    <div class="section-title">
                        <h4 class="section-45px-montserrat margin-top-15 margin-bottom-20">Pentingnya Iklan Facebook</h4>
                    </div>
                    <p class="section-17px-regular margin-bottom-25">
                        Facebook merupakan salah satu platform tersebesar paling aktif di Indonesia dengan total 130 Juta pengguna yang dapat dijangkau dengan Iklan Facebook. Gunakan Jasa Iklan Facebook untuk mengenalkan dan mengembangkan bisnis anda menjadi lebih luas dan efektif.
                        <br><br>
                        GoSocial menyediakan layanan Jasa Iklan Facebook untuk mengatur strategi, budget, hingga pengelolaan campaign iklan di Facebook untuk beragam kebutuhan bisnis seperti meningkatkan brand awareness, meningkatkan sales, dan sebagainya.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="about-content-right wow fadeInUp" data-wow-delay="0ms"
                    data-wow-duration="1500ms">
                    <div class="section-title">
                        <h4 class="section-45px-montserrat margin-top-15 margin-bottom-20">Kembangkan bisnis melalui Facebook Ads</h4>
                    </div>
                    <p class="section-17px-regular margin-bottom-25">
                        Jangkau lebih banyak audiens potensial di Facebook menggunakan Iklan Facebook secara tertarget dan spesifik, lalu kenalkan bisnis anda lebih jauh dengan strategi yang efektif dan efisien untuk mendapatkan konversi sales yang tinggi.
                        <br><br>
                        Kembangkan bisnismu lebih luas, tingkatkan traffic, serta konversi sales menggunakan Jasa Iklan Facebook bersama tim profesional GoSocial.
                    </p>
                </div>
            </div>
            <div class="col-md-6">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="section-title wow fadeInDown">
                    <h2 class="section-45px-montserrat margin-top-15">Tahapan Iklan FB Ads</h2>
                </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="section-title wow fadeInDown">
                    ...
                    <p class="text-muted">Solusi terlengkap untuk memulai campaign Facebook Ads secepatnya</p>
                </div>
                <div class="themesflat-spacer clearfix" data-desktop="47" data-mobile="60" data-smobile="60"
                    style="height:60px"></div>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="section-title wow fadeInDown">
                    ...
                    <h2 class="section-45px-montserrat margin-top-15">Paket Harga Iklan Facebook.</h2>
