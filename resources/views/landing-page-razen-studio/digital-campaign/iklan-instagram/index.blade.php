...
@section('title', $iklan_instagram_section_1['title'])
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="breadcrumbs text-center link-style-5 text-white">
                <h1 class="section-title-page text-white">{{$iklan_instagram_section_1['judul']}}</h1>
                <p class="mb-5">{{$iklan_instagram_section_1['deskripsi']}}</p>
                <ul class="breadcrumbs-inner list-center display-flex">
                    ...
                    <li>
                        <h4 class="section-16px-regular font-weight-500 text-white">{{$iklan_instagram_section_1['judul']}}</h4>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="col-md-6">
                <div class="about-content-left wow fadeInLeft">
                    <div class="about-post">
                        <img src="{{ asset('images/landingpage_razenstudio/digital-campaign/iklan-instagram/'.$iklan_instagram_section_2['gambar']) }}" alt="images">
            ...
            <div class="col-md-6">
                <div class="about-content-right wow fadeInUp" data-wow-delay="0ms"
                    ...
                    <div class="section-title">
                        <h4 class="section-45px-montserrat margin-top-15 margin-bottom-20">{{$iklan_instagram_section_2['judul']}}</h4>
                    </div>
                    <p class="section-17px-regular margin-bottom-25">{!! $iklan_instagram_section_2['deskripsi'] !!}</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="about-content-right wow fadeInUp" data-wow-delay="0ms"
                    data-wow-duration="1500ms">
                    <div class="section-title">
                        <h4 class="section-45px-montserrat margin-top-15 margin-bottom-20">{{$iklan_instagram_section_3['judul']}}</h4>
                    </div>
                    <p class="section-17px-regular margin-bottom-25">{!! $iklan_instagram_section_3['deskripsi'] !!}</p>
                </div>
            </div>
            <div class="col-md-6">
                <div class="about-content-left wow fadeInLeft">
                    <div class="about-post">
                        <img src="{{ asset('images/landingpage_razenstudio/digital-campaign/iklan-instagram/'.$iklan_instagram_section_3['gambar']) }}" alt="images">
                        <div class="mark-about-post"></div>
                    </div>
                </div>
            </div>
            ...
            <div class="card bg-danger text-white overflow-hidden p-5">
                <div class="row justify-content-md-start align-items-md-center text-center text-md-left">
                    <div class="col-md-6 offset-md-3 mb-3 mb-md-0">
                        <h3 class="text-white font-size-3 mb-1">{{$iklan_instagram_section_4['judul']}}</h3>
                        <p class="text-white-70 font-size-2 mb-0">{{$iklan_instagram_section_4['deskripsi']}}</p>
                    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="section-title wow fadeInDown">
                    <h2 class="section-45px-montserrat margin-top-15">{{$iklan_instagram_section_5['judul']}}</h2>
                </div>
...
<section class="flat-services">
    <div class="container space-2">
        <div class="row">
            <div class="col-md-12">
                <div class="section-title wow fadeInDown">
                    <h2 class="section-45px-montserrat margin-top-15">{{$iklan_instagram_section_6['judul']}}</h2>
                    <p class="text-muted">{{$iklan_instagram_section_6['deskripsi']}}</p>
                </div>
                <div class="themesflat-spacer clearfix" data-desktop="47" data-mobile="60" data-smobile="60"
                    style="height:60px"></div>
            </div>
        ...
        <div class="row">
            @php
                ...
                $item_3 = [];
                $item_4 = [];
                foreach ($iklan_instagram_section_6['item'] as $value) {
            ...
            <div class="col-md-4 mb-7">
                ...
                <div class="text-center px-lg-3">
                    <figure class="max-w-10rem mx-auto mb-4">
                        <img class="img-fluid" src="{{ asset('images/landingpage_razenstudio/digital-campaign/iklan-instagram/'.$item_1['ikon']) }}" alt="SVG">
                    </figure>
                    <h2>{{$item_1['judul']}}</h2>
            ...
            <div class="col-md-4 mb-7">
                ...
                <div class="text-center px-lg-3">
                    <figure class="max-w-10rem mx-auto mb-4">
                        <img class="img-fluid" src="{{ asset('images/landingpage_razenstudio/digital-campaign/iklan-instagram/'.$item_2['ikon']) }}" alt="SVG">
                    </figure>
                    <h2>{{$item_2['judul']}}</h2>
            ...
            <div class="col-md-4 mb-7">
                ...
                <div class="text-center px-lg-3">
                    <figure class="max-w-10rem mx-auto mb-4">
                        <img class="img-fluid" src="{{ asset('images/landingpage_razenstudio/digital-campaign/iklan-instagram/'.$item_3['ikon']) }}" alt="SVG">
                    </figure>
                    <h2>{{$item_3['judul']}}</h2>
        ...
        <div class="position-relative">
            <div class="device d-none d-sm-block mb-3 mb-sm-0 aos-init">
                ...
                <img class="device-macbook-screen" src="{{ asset('images/landingpage_razenstudio/digital-campaign/iklan-instagram/'.$item_4['gambar']) }}" alt="Instagram Ads Manager Dashboard">
            </div>
        </div>
        <!-- End Browser Mockup -->
...
<section class="flat-services">
    <div class="container space-2">
        <div class="row">
            <div class="col-12">
                <div class="section-title wow fadeInDown">
                    <h4 class="section-subtitle">{{$iklan_instagram_section_7['sub_judul']}}</h4>
                    <h2 class="section-45px-montserrat margin-top-15">{{$iklan_instagram_section_7['judul']}}</h2>
                    <p class="text-muted">{{$iklan_instagram_section_7['deskripsi']}}</p>
                </div>
                <div class="themesflat-spacer clearfix" data-desktop="47" data-mobile="60" data-smobile="60"
                    style="height:60px"></div>
            </div>
                ...
                <div class="col-md-4 mb-7 mb-md-0 justify-content-center align-self-center">
                    ...
                    <div class="media">
                        <figure class="w-100 max-w-15rem mr-4">
                            <img class="img-fluid" src="{{ asset('images/landingpage_razenstudio/digital-campaign/iklan-instagram/'.$item['logo_konten']) }}" alt="SVG">
                        </figure>
...
<section class="flat-services">
    <div class="container space-2 space-top-lg-2">
        <div class="row">
            <div class="col-12">
                <div class="section-title wow fadeInDown">
                    <h4 class="section-subtitle">{{$iklan_instagram_section_9['sub_judul']}}</h4>
                    <h2 class="section-45px-montserrat margin-top-15">{{$iklan_instagram_section_9['judul']}}</h2>
                </div>
                <div class="themesflat-spacer clearfix" data-desktop="47" data-mobile="60" data-smobile="60"
                    style="height:60px"></div>
            </div>
                ...
                <div class="card p-5 mb-3">
                    <div class="row align-items-sm-center">
                        <div class="col-lg-4 mb-3 mb-lg-0 d-flex flex-row align-items-center">
                            <img class="mr-3" src="{{ asset('images/landingpage_razenstudio/digital-campaign/iklan-instagram/'.$item['logo_konten']) }}" alt="Shopee Collaborative Ads" width="50" height="50">
                            ...
                            <div class="swiper-slide">
                                <div class="client-slider-box">
                                    <div class="client-user text-center">
                                        <img src="{{ asset('images/landingpage_razenstudio/digital-campaign/iklan-instagram/testimoni/'.$testimoni->gambar) }}"
                                            alt="images">
...
<section class="flat-services">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="section-title wow fadeInDown">
                    <h4 class="section-subtitle">{{$iklan_instagram_section_10['sub_judul']}}</h4>
                    <h2 class="section-45px-montserrat margin-top-15">{{$iklan_instagram_section_10['judul']}}</h2>
                </div>
                <div class="themesflat-spacer clearfix" data-desktop="47" data-mobile="60" data-smobile="60"
                    style="height:60px"></div>
            </div>
