...
class IklanInstagramController extends Controller
{
    public function index()
    {
        return view('razen-studio.admin.landing-page.digital-campaign.iklan-instagram.index');
    }
    ...
    public function section_1_store(Request $request)
    {
        ...
        if($errors -> fails())
        {
            ...
            return redirect()->route('razen-studio.admin.digital-campaign.iklan-instagram.index');
        }

        $cek = LandingpageRazenstudioIklanInstagram::first();
        if($cek)
        {
            $landingpage_razenstudio_iklan_instagram = LandingpageRazenstudioIklanInstagram::find($cek->id);
        } else {
            $landingpage_razenstudio_iklan_instagram = new LandingpageRazenstudioIklanInstagram;
        }
        $array = [
            'title' => $request->title,
            'judul' => $request->judul,
        ...
        $landingpage_razenstudio_iklan_instagram->section_1 = json_encode($array);
        $landingpage_razenstudio_iklan_instagram->save();
    ...
    public function section_2_store(Request $request)
    {
        ...
        {
            $landingpage_razenstudio_iklan_instagram = LandingpageRazenstudioIklanInstagram::find($cek->id);
            if($landingpage_razenstudio_iklan_instagram->section_2)
            {
                $get_section_2 = json_decode($landingpage_razenstudio_iklan_instagram->section_2, true);

                if ($request->gambar) {
                    $gambarName = $get_section_2['gambar'];
                    File::delete(public_path('images/landingpage_razenstudio/digital-campaign/iklan-instagram/'.$gambarName));

                    $gambarExtension = $request->gambar->extension();
                    $gambarName =  uniqid().'-'.date("ymd").'.'.$gambarExtension;
                    $gambar = Image::make($request->gambar);
                    $gambarSize = public_path('images/landingpage_razenstudio/digital-campaign/iklan-instagram/'.$gambarName);
        ...
        $landingpage_razenstudio_iklan_instagram->section_2 = json_encode($array);
        $landingpage_razenstudio_iklan_instagram->save();
    ...
    public function section_3_store(Request $request)
    {
        ...
        {
            $landingpage_razenstudio_iklan_instagram = LandingpageRazenstudioIklanInstagram::find($cek->id);
            if($landingpage_razenstudio_iklan_instagram->section_3)
            {
                $get_section_3 = json_decode($landingpage_razenstudio_iklan_instagram->section_3, true);
        ...
        $landingpage_razenstudio_iklan_instagram->section_3 = json_encode($array);
        $landingpage_razenstudio_iklan_instagram->save();
    ...
    public function section_4_store(Request $request)
    {
        ...
        $landingpage_razenstudio_iklan_instagram->section_4 = json_encode($array);
        $landingpage_razenstudio_iklan_instagram->save();
    ...
    public function section_5_store(Request $request)
    {
        ...
        $landingpage_razenstudio_iklan_instagram ->section_5 = json_encode($array);
        $landingpage_razenstudio_iklan_instagram ->save();
    ...
    {
        $get = LandingpageRazenstudioIklanInstagram::first();
        ...
        $landingpage_razenstudio_iklan_instagram  = LandingpageRazenstudioIklanInstagram::find($get->id);
        $landingpage_razenstudio_iklan_instagram ->section_5 = json_encode($data);
        $landingpage_razenstudio_iklan_instagram ->save();
    ...
    public function section_6_store(Request $request)
    {
        ...
        {
            $landingpage_razenstudio_iklan_instagram = LandingpageRazenstudioIklanInstagram::find($cek->id);
            $section6 = json_decode($landingpage_razenstudio_iklan_instagram->section_6, true);
            $array_lama = [];
        ...
        $landingpage_razenstudio_iklan_instagram->section_6 = json_encode($array);
        $landingpage_razenstudio_iklan_instagram->save();
    ...
    public function section_6_item_1_store(Request $request)
    {
        ...
        if($cek)
        {
            $iklan_instagram = LandingpageRazenstudioIklanInstagram::find($cek->id);
            $section6 = json_decode($iklan_instagram->section_6, true);
            $array_baru = [];
            $array_lama = [];
            ...
            if($request->ikon)
            {
                ...
                $ikonSize = public_path('images/landingpage_razenstudio/digital-campaign/iklan-instagram/'.$ikonName);
            ...
            $iklan_instagram->section_6 = json_encode($data);
            $iklan_instagram->save();
        ...
        if($cek)
        {
            ...
            foreach ($section6['item'] as $value) {
                ...
                if($value['item'] == 'item_2')
                {
                    if($request->ikon)
                    {
                        File::delete(public_path('images/landingpage_razenstudio/digital-campaign/iklan-instagram/'.$value['ikon']));
                    } else {
                        $array_lama[] = [
                            'item' => $value['item'],
                            'judul' => $request->judul,
        ...
        if($cek)
        {
            ...
            foreach ($section6['item'] as $value) {
                ...
                if($value['item'] == 'item_4')
                {
                    if($request->gambar)
                    {
                        File::delete(public_path('images/landingpage_razenstudio/digital-campaign/iklan-instagram/'.$value['gambar']));
                    } else {
                        $array_lama[] = [
                            'item' => $value['item'],
                            'judul' => $value['judul'],
    ...
    public function section_7_store(Request $request)
    {
        ...
        $landingpage_razenstudio_iklan_instagram->section_7 = json_encode($array);
        $landingpage_razenstudio_iklan_instagram->save();
    ...
    public function section_8_store(Request $request)
    {
        ...
        $landingpage_razenstudio_iklan_instagram ->section_8 = json_encode($array_konten);
        $landingpage_razenstudio_iklan_instagram ->save();
    ...
    public function section_8_edit(Request $request)
    {
        ...
        $landingpage_razenstudio_iklan_instagram  = LandingpageRazenstudioIklanInstagram::find($get->id);
        $landingpage_razenstudio_iklan_instagram ->section_8 = json_encode(array_merge($array_lama, $array_baru));
        $landingpage_razenstudio_iklan_instagram ->save();
    ...
    public function section_8_hapus_satu(Request $request)
    {
        ...
        foreach ($section8 as $value) {
            if($value['id'] == $request->id)
            {
                File::delete(public_path('images/landingpage_razenstudio/digital-campaign/iklan-instagram/'.$value['logo_konten']));
            } else {
                $array_konten[] = [
                    'id' => $value['id'],
                    'judul_konten' => $value['judul_konten'],
    ...
    public function section_9_store(Request $request)
    {
        ...
        $landingpage_razenstudio_iklan_instagram ->section_9 = json_encode($array_data);
        $landingpage_razenstudio_iklan_instagram ->save();
    ...
    public function section_9_hapus_satu(Request $request)
    {
        ...
        $landingpage_razenstudio_iklan_instagram  = LandingpageRazenstudioIklanInstagram::find($get->id);
        $landingpage_razenstudio_iklan_instagram ->section_9 = json_encode($data);
        $landingpage_razenstudio_iklan_instagram ->save();
    ...
    public function section_10_store(Request $request)
    {
        ...
        $landingpage_razenstudio_iklan_instagram->section_10 = json_encode($array);
        $landingpage_razenstudio_iklan_instagram->save();
    ...
    public function section_10_hapus_satu(Request $request)
    {
        ...
        $landingpage_razenstudio_iklan_instagram = LandingpageRazenstudioIklanInstagram::find($get->id);
        $landingpage_razenstudio_iklan_instagram->section_10 = json_encode($data);
        $landingpage_razenstudio_iklan_instagram->save();
