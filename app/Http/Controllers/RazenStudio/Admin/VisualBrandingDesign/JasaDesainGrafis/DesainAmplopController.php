...
class DesainAmplopController extends Controller
{
    public function index()
    {
        return view('razen-studio.admin.landing-page.visual-branding-design.jasa-desain-grafis.desain-amplop.index');
    }
    ...
    public function section_1_store(Request $request)
    {
        ...
        if($errors -> fails())
        {
            ...
            return redirect()->route('razen-studio.admin.visual-branding-design.jasa-desain-grafis.desain-amplop.index');
        }

        $cek = LandingpageRazenstudioDesainAmplop::first();
        if($cek)
        {
            $landingpage_razenstudio_desain_amplop = LandingpageRazenstudioDesainAmplop::find($cek->id);
        } else {
            $landingpage_razenstudio_desain_amplop = new LandingpageRazenstudioDesainAmplop;
        }
        $array = [
            'title' => $request->title,
            'judul' => $request->judul,
        ...
        $landingpage_razenstudio_desain_amplop->section_1 = json_encode($array);
        $landingpage_razenstudio_desain_amplop->save();
    ...
    public function section_2_store(Request $request)
    {
        ...
        {
            $landingpage_razenstudio_desain_amplop = LandingpageRazenstudioDesainAmplop::find($cek->id);
            if($landingpage_razenstudio_desain_amplop->section_2)
            {
                $get_section_2 = json_decode($landingpage_razenstudio_desain_amplop->section_2, true);

                if ($request->gambar) {
                    $gambarName = $get_section_2['gambar'];
                    File::delete(public_path('images/landingpage_razenstudio/visual-branding-design/jasa-desain-grafis/desain-amplop/'.$gambarName));

                    $gambarExtension = $request->gambar->extension();
                    $gambarName =  uniqid().'-'.date("ymd").'.'.$gambarExtension;
                    $gambar = Image::make($request->gambar);
                    $gambarSize = public_path('images/landingpage_razenstudio/visual-branding-design/jasa-desain-grafis/desain-amplop/'.$gambarName);
        ...
        $landingpage_razenstudio_desain_amplop->section_2 = json_encode($array);
        $landingpage_razenstudio_desain_amplop->save();
    ...
    public function section_3_store(Request $request)
    {
        ...
        {
            $landingpage_razenstudio_desain_amplop = LandingpageRazenstudioDesainAmplop::find($cek->id);
            if($landingpage_razenstudio_desain_amplop->section_3)
            {
                $get_section_3 = json_decode($landingpage_razenstudio_desain_amplop->section_3, true);
        ...
        $landingpage_razenstudio_desain_amplop->section_3 = json_encode($array);
        $landingpage_razenstudio_desain_amplop->save();
    ...
    public function section_4_store(Request $request)
    {
        ...
        $landingpage_razenstudio_desain_amplop->section_4 = json_encode($array);
        $landingpage_razenstudio_desain_amplop->save();
    ...
    public function section_5_store(Request $request)
    {
        ...
        $landingpage_razenstudio_desain_amplop ->section_5 = json_encode($array);
        $landingpage_razenstudio_desain_amplop ->save();
    ...
    {
        $get = LandingpageRazenstudioDesainAmplop::first();
        ...
        $landingpage_razenstudio_desain_amplop  = LandingpageRazenstudioDesainAmplop::find($get->id);
        $landingpage_razenstudio_desain_amplop ->section_5 = json_encode($data);
        $landingpage_razenstudio_desain_amplop ->save();
    ...
    public function section_6_store(Request $request)
    {
        ...
        {
            $landingpage_razenstudio_desain_amplop = LandingpageRazenstudioDesainAmplop::find($cek->id);
            $section6 = json_decode($landingpage_razenstudio_desain_amplop->section_6, true);
            $array_lama = [];
        ...
        $landingpage_razenstudio_desain_amplop->section_6 = json_encode($array);
        $landingpage_razenstudio_desain_amplop->save();
    ...
    public function section_6_item_1_store(Request $request)
    {
        ...
        if($cek)
        {
            $video_konten_sosmed = LandingpageRazenstudioDesainAmplop::find($cek->id);
    ...
    public function section_6_item_2_store(Request $request)
    {
        ...
        if($cek)
        {
            ...
            if($request->ikon)
            {
                ...
                $ikonSize = public_path('images/landingpage_razenstudio/visual-branding-design/jasa-desain-grafis/desain-amplop/'.$ikonName);
            ...
            foreach ($section6['item'] as $value) {
                ...
                if($value['item'] == 'item_2')
                {
                    if($request->ikon)
                    {
                        File::delete(public_path('images/landingpage_razenstudio/visual-branding-design/jasa-desain-grafis/desain-amplop/'.$value['ikon']));
                    } else {
                        $array_lama[] = [
                            'item' => $value['item'],
                            'judul' => $request->judul,
    ...
    public function section_7_store(Request $request)
    {
        ...
        $landingpage_razenstudio_desain_amplop->section_7 = json_encode($array_data);
        $landingpage_razenstudio_desain_amplop->save();
    ...
    public function section_7_hapus_satu(Request $request)
    {
        ...
        foreach ($section7['konten'] as $value) {
            if($value['id'] == $request->id)
            {
                File::delete(public_path('images/landingpage_razenstudio/visual-branding-design/jasa-desain-grafis/desain-amplop/'.$value['gambar_konten']));
            } else {
                $array_konten[] = [
                    'id' => $value['id'],
                    'judul_konten' => $value['judul_konten'],
        ...
        $landingpage_razenstudio_desain_amplop = LandingpageRazenstudioDesainAmplop::find($get->id);
        $landingpage_razenstudio_desain_amplop->section_7 = json_encode($data);
        $landingpage_razenstudio_desain_amplop->save();
    ...
    public function section_8_store(Request $request)
    {
        ...
        $landingpage_razenstudio_desain_amplop->section_8 = json_encode($array);
        $landingpage_razenstudio_desain_amplop->save();
    ...
    public function section_8_hapus_satu(Request $request)
    {
        ...
        $landingpage_razenstudio_desain_amplop = LandingpageRazenstudioDesainAmplop::find($get->id);
        $landingpage_razenstudio_desain_amplop->section_8 = json_encode($data);
        $landingpage_razenstudio_desain_amplop->save();
