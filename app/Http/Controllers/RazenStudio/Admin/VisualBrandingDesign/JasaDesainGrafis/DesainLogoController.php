...
class DesainLogoController extends Controller
{
    public function index()
    {
        return view('razen-studio.admin.landing-page.visual-branding-design.jasa-desain-grafis.desain-logo.index');
    }
    ...
    public function section_1_store(Request $request)
    {
        ...
        if($errors -> fails())
        {
            ...
            return redirect()->route('razen-studio.admin.visual-branding-design.jasa-desain-grafis.desain-logo.index');
        }

        $cek = LandingpageRazenstudioDesainLogo::first();
        if($cek)
        {
            $landingpage_razenstudio_desain_logo = LandingpageRazenstudioDesainLogo::find($cek->id);
        } else {
            $landingpage_razenstudio_desain_logo = new LandingpageRazenstudioDesainLogo;
        }
        $array = [
            'title' => $request->title,
            'judul' => $request->judul,
        ...
        $landingpage_razenstudio_desain_logo->section_1 = json_encode($array);
        $landingpage_razenstudio_desain_logo->save();
    ...
    public function section_2_store(Request $request)
    {
        ...
        {
            $landingpage_razenstudio_desain_logo = LandingpageRazenstudioDesainLogo::find($cek->id);
            if($landingpage_razenstudio_desain_logo->section_2)
            {
                $get_section_2 = json_decode($landingpage_razenstudio_desain_logo->section_2, true);

                if ($request->gambar) {
                    $gambarName = $get_section_2['gambar'];
                    File::delete(public_path('images/landingpage_razenstudio/visual-branding-design/jasa-desain-grafis/desain-logo/'.$gambarName));

                    $gambarExtension = $request->gambar->extension();
                    $gambarName =  uniqid().'-'.date("ymd").'.'.$gambarExtension;
                    $gambar = Image::make($request->gambar);
                    $gambarSize = public_path('images/landingpage_razenstudio/visual-branding-design/jasa-desain-grafis/desain-logo/'.$gambarName);
        ...
        $landingpage_razenstudio_desain_logo->section_2 = json_encode($array);
        $landingpage_razenstudio_desain_logo->save();
    ...
    public function section_3_store(Request $request)
    {
        ...
        {
            $landingpage_razenstudio_desain_logo = LandingpageRazenstudioDesainLogo::find($cek->id);
            if($landingpage_razenstudio_desain_logo->section_3)
            {
                $get_section_3 = json_decode($landingpage_razenstudio_desain_logo->section_3, true);
        ...
        $landingpage_razenstudio_desain_logo->section_3 = json_encode($array);
        $landingpage_razenstudio_desain_logo->save();
    ...
    public function section_4_store(Request $request)
    {
        ...
        $landingpage_razenstudio_desain_logo->section_4 = json_encode($array);
        $landingpage_razenstudio_desain_logo->save();
    ...
    public function section_5_store(Request $request)
    {
        ...
        $landingpage_razenstudio_desain_logo ->section_5 = json_encode($array);
        $landingpage_razenstudio_desain_logo ->save();
    ...
    {
        $get = LandingpageRazenstudioDesainLogo::first();
        ...
        $landingpage_razenstudio_desain_logo  = LandingpageRazenstudioDesainLogo::find($get->id);
        $landingpage_razenstudio_desain_logo ->section_5 = json_encode($data);
        $landingpage_razenstudio_desain_logo ->save();
    ...
    public function section_6_store(Request $request)
    {
        ...
        $landingpage_razenstudio_desain_logo->section_6 = json_encode($array);
        $landingpage_razenstudio_desain_logo->save();
    ...
    public function section_6_item_store(Request $request)
    {
        ...
        $item_penilaian_desain_logo = new LandingpageRazenstudioItemDesainLogo;
        $item_penilaian_desain_logo->judul = $request->judul;
        if($request->harga)
        {
            $item_penilaian_desain_logo->harga = $request->harga;
        } else {
            $item_penilaian_desain_logo->harga_custom = $request->harga_custom;
        }
        if($request->gambar)
        {
            $gambarExtension = $request->gambar->extension();
            ...
            $item_penilaian_desain_logo->gambar = $gambarName;
        }
        $item_penilaian_desain_logo->item_penilaian = json_encode($data_item_penilaian);
        $item_penilaian_desain_logo->save();
    ...
    {
        $paket_harga = LandingpageRazenstudioItemDesainLogo::find($request->id);
        $paket_harga->delete();
    ...
    public function section_7_store(Request $request)
    {
        ...
        $landingpage_razenstudio_desain_logo->section_7 = json_encode($array_data);
        $landingpage_razenstudio_desain_logo->save();
    ...
    public function section_7_hapus_satu(Request $request)
    {
        ...
        foreach ($section7['konten'] as $value) {
            if($value['id'] == $request->id)
            {
                File::delete(public_path('images/landingpage_razenstudio/visual-branding-design/jasa-desain-grafis/desain-logo/'.$value['gambar_konten']));
            } else {
                $array_konten[] = [
                    'id' => $value['id'],
                    'judul_konten' => $value['judul_konten'],
        ...
        $landingpage_razenstudio_desain_logo = LandingpageRazenstudioDesainLogo::find($get->id);
        $landingpage_razenstudio_desain_logo->section_7 = json_encode($data);
        $landingpage_razenstudio_desain_logo->save();
    ...
    public function section_8_store(Request $request)
    {
        ...
        $landingpage_razenstudio_desain_logo->section_8 = json_encode($array);
        $landingpage_razenstudio_desain_logo->save();
    ...
    public function section_8_hapus_satu(Request $request)
    {
        ...
        $landingpage_razenstudio_desain_logo = LandingpageRazenstudioDesainLogo::find($get->id);
        $landingpage_razenstudio_desain_logo->section_8 = json_encode($data);
        $landingpage_razenstudio_desain_logo->save();
