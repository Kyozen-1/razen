...
class DesainBrandingEventController extends Controller
{
    public function index()
    {
        return view('razen-studio.admin.landing-page.visual-branding-design.jasa-desain-grafis.desain-branding-event.index');
    }
    ...
    public function section_1_store(Request $request)
    {
        ...
        if($errors -> fails())
        {
            ...
            return redirect()->route('razen-studio.admin.visual-branding-design.jasa-desain-grafis.desain-branding-event.index');
        }

        $cek = LandingpageRazenstudioDesainBrandingEvent::first();
        if($cek)
        {
            $landingpage_razenstudio_desain_branding_event = LandingpageRazenstudioDesainBrandingEvent::find($cek->id);
        } else {
            $landingpage_razenstudio_desain_branding_event = new LandingpageRazenstudioDesainBrandingEvent;
        }
        $array = [
            'title' => $request->title,
            'judul' => $request->judul,
        ...
        $landingpage_razenstudio_desain_branding_event->section_1 = json_encode($array);
        $landingpage_razenstudio_desain_branding_event->save();
    ...
    public function section_2_store(Request $request)
    {
        ...
        {
            $landingpage_razenstudio_desain_branding_event = LandingpageRazenstudioDesainBrandingEvent::find($cek->id);
            if($landingpage_razenstudio_desain_branding_event->section_2)
            {
                $get_section_2 = json_decode($landingpage_razenstudio_desain_branding_event->section_2, true);

                if ($request->gambar) {
                    $gambarName = $get_section_2['gambar'];
                    File::delete(public_path('images/landingpage_razenstudio/visual-branding-design/jasa-desain-grafis/desain-branding-event/'.$gambarName));

                    $gambarExtension = $request->gambar->extension();
                    $gambarName =  uniqid().'-'.date("ymd").'.'.$gambarExtension;
                    $gambar = Image::make($request->gambar);
                    $gambarSize = public_path('images/landingpage_razenstudio/visual-branding-design/jasa-desain-grafis/desain-branding-event/'.$gambarName);
        ...
        $landingpage_razenstudio_desain_branding_event->section_2 = json_encode($array);
        $landingpage_razenstudio_desain_branding_event->save();
    ...
    public function section_3_store(Request $request)
    {
        ...
        {
            $landingpage_razenstudio_desain_branding_event = LandingpageRazenstudioDesainBrandingEvent::find($cek->id);
            if($landingpage_razenstudio_desain_branding_event->section_3)
            {
                $get_section_3 = json_decode($landingpage_razenstudio_desain_branding_event->section_3, true);
        ...
        $landingpage_razenstudio_desain_branding_event->section_3 = json_encode($array);
        $landingpage_razenstudio_desain_branding_event->save();
    ...
    public function section_4_store(Request $request)
    {
        ...
        $landingpage_razenstudio_desain_branding_event->section_4 = json_encode($array);
        $landingpage_razenstudio_desain_branding_event->save();
    ...
    public function section_5_store(Request $request)
    {
        ...
        $landingpage_razenstudio_desain_branding_event ->section_5 = json_encode($array);
        $landingpage_razenstudio_desain_branding_event ->save();
    ...
    {
        $get = LandingpageRazenstudioDesainBrandingEvent::first();
        ...
        $landingpage_razenstudio_desain_branding_event  = LandingpageRazenstudioDesainBrandingEvent::find($get->id);
        $landingpage_razenstudio_desain_branding_event ->section_5 = json_encode($data);
        $landingpage_razenstudio_desain_branding_event ->save();
    ...
    public function section_6_store(Request $request)
    {
        ...
        {
            $landingpage_razenstudio_desain_branding_event = LandingpageRazenstudioDesainBrandingEvent::find($cek->id);
            $section6 = json_decode($landingpage_razenstudio_desain_branding_event->section_6, true);
            $array_lama = [];
        ...
        $landingpage_razenstudio_desain_branding_event->section_6 = json_encode($array);
        $landingpage_razenstudio_desain_branding_event->save();
    ...
    public function section_6_item_1_store(Request $request)
    {
        ...
        if($cek)
        {
            $video_konten_sosmed = LandingpageRazenstudioDesainBrandingEvent::find($cek->id);
    ...
    public function section_6_item_2_store(Request $request)
    {
        ...
        if($cek)
        {
            ...
            if($request->ikon)
            {
                ...
                $ikonSize = public_path('images/landingpage_razenstudio/visual-branding-design/jasa-desain-grafis/desain-branding-event/'.$ikonName);
            ...
            foreach ($section6['item'] as $value) {
                ...
                if($value['item'] == 'item_2')
                {
                    if($request->ikon)
                    {
                        File::delete(public_path('images/landingpage_razenstudio/visual-branding-design/jasa-desain-grafis/desain-branding-event/'.$value['ikon']));
                    } else {
                        $array_lama[] = [
                            'item' => $value['item'],
                            'judul' => $request->judul,
    ...
    public function section_7_store(Request $request)
    {
        ...
        $landingpage_razenstudio_desain_branding_event->section_7 = json_encode($array_data);
        $landingpage_razenstudio_desain_branding_event->save();
    ...
    public function section_7_hapus_satu(Request $request)
    {
        ...
        foreach ($section7['konten'] as $value) {
            if($value['id'] == $request->id)
            {
                File::delete(public_path('images/landingpage_razenstudio/visual-branding-design/jasa-desain-grafis/desain-branding-event/'.$value['gambar_konten']));
            } else {
                $array_konten[] = [
                    'id' => $value['id'],
                    'judul_konten' => $value['judul_konten'],
        ...
        $landingpage_razenstudio_desain_branding_event = LandingpageRazenstudioDesainBrandingEvent::find($get->id);
        $landingpage_razenstudio_desain_branding_event->section_7 = json_encode($data);
        $landingpage_razenstudio_desain_branding_event->save();
    ...
    public function section_8_store(Request $request)
    {
        ...
        $landingpage_razenstudio_desain_branding_event->section_8 = json_encode($array);
        $landingpage_razenstudio_desain_branding_event->save();
    ...
    public function section_8_hapus_satu(Request $request)
    {
        ...
        $landingpage_razenstudio_desain_branding_event = LandingpageRazenstudioDesainBrandingEvent::find($get->id);
        $landingpage_razenstudio_desain_branding_event->section_8 = json_encode($data);
        $landingpage_razenstudio_desain_branding_event->save();
