...
class DesainBrandingKitController extends Controller
{
    public function index()
    {
        return view('razen-studio.admin.landing-page.visual-branding-design.jasa-desain-grafis.desain-branding-kit.index');
    }
    ...
    public function section_1_store(Request $request)
    {
        ...
        if($errors -> fails())
        {
            ...
            return redirect()->route('razen-studio.admin.visual-branding-design.jasa-desain-grafis.desain-branding-kit.index');
        }

        $cek = LandingpageRazenstudioDesainBrandingKit::first();
        if($cek)
        {
            $landingpage_razenstudio_desain_branding_kit = LandingpageRazenstudioDesainBrandingKit::find($cek->id);
        } else {
            $landingpage_razenstudio_desain_branding_kit = new LandingpageRazenstudioDesainBrandingKit;
        }
        $array = [
            'title' => $request->title,
            'judul' => $request->judul,
        ...
        $landingpage_razenstudio_desain_branding_kit->section_1 = json_encode($array);
        $landingpage_razenstudio_desain_branding_kit->save();
    ...
    public function section_2_store(Request $request)
    {
        ...
        {
            $landingpage_razenstudio_desain_branding_kit = LandingpageRazenstudioDesainBrandingKit::find($cek->id);
            if($landingpage_razenstudio_desain_branding_kit->section_2)
            {
                $get_section_2 = json_decode($landingpage_razenstudio_desain_branding_kit->section_2, true);

                if ($request->gambar) {
                    $gambarName = $get_section_2['gambar'];
                    File::delete(public_path('images/landingpage_razenstudio/visual-branding-design/jasa-desain-grafis/desain-branding-kit/'.$gambarName));

                    $gambarExtension = $request->gambar->extension();
                    $gambarName =  uniqid().'-'.date("ymd").'.'.$gambarExtension;
                    $gambar = Image::make($request->gambar);
                    $gambarSize = public_path('images/landingpage_razenstudio/visual-branding-design/jasa-desain-grafis/desain-branding-kit/'.$gambarName);
        ...
        $landingpage_razenstudio_desain_branding_kit->section_2 = json_encode($array);
        $landingpage_razenstudio_desain_branding_kit->save();
    ...
    public function section_3_store(Request $request)
    {
        ...
        {
            $landingpage_razenstudio_desain_branding_kit = LandingpageRazenstudioDesainBrandingKit::find($cek->id);
            if($landingpage_razenstudio_desain_branding_kit->section_3)
            {
                $get_section_3 = json_decode($landingpage_razenstudio_desain_branding_kit->section_3, true);
        ...
        $landingpage_razenstudio_desain_branding_kit->section_3 = json_encode($array);
        $landingpage_razenstudio_desain_branding_kit->save();
    ...
    public function section_4_store(Request $request)
    {
        ...
        $landingpage_razenstudio_desain_branding_kit->section_4 = json_encode($array);
        $landingpage_razenstudio_desain_branding_kit->save();
    ...
    public function section_5_store(Request $request)
    {
        ...
        $landingpage_razenstudio_desain_branding_kit ->section_5 = json_encode($array);
        $landingpage_razenstudio_desain_branding_kit ->save();
    ...
    {
        $get = LandingpageRazenstudioDesainBrandingKit::first();
        ...
        $landingpage_razenstudio_desain_branding_kit  = LandingpageRazenstudioDesainBrandingKit::find($get->id);
        $landingpage_razenstudio_desain_branding_kit ->section_5 = json_encode($data);
        $landingpage_razenstudio_desain_branding_kit ->save();
    ...
    public function section_6_store(Request $request)
    {
        ...
        $landingpage_razenstudio_desain_branding_kit->section_6 = json_encode($array);
        $landingpage_razenstudio_desain_branding_kit->save();
    ...
    public function section_6_item_store(Request $request)
    {
        ...
        $item_penilaian_desain_branding_kit = new LandingpageRazenstudioItemDesainBrandingKit;
        $item_penilaian_desain_branding_kit->judul = $request->judul;
        $item_penilaian_desain_branding_kit->harga = $request->harga;
        $item_penilaian_desain_branding_kit->item_penilaian = json_encode($data_item_penilaian);
        $item_penilaian_desain_branding_kit->save();
    ...
    {
        $branding_kit = LandingpageRazenstudioItemDesainBrandingKit::find($request->id);
        $branding_kit->delete();
    ...
    public function section_7_store(Request $request)
    {
        ...
        $landingpage_razenstudio_desain_branding_kit->section_7 = json_encode($array_data);
        $landingpage_razenstudio_desain_branding_kit->save();
    ...
    public function section_7_hapus_satu(Request $request)
    {
        ...
        foreach ($section7['konten'] as $value) {
            if($value['id'] == $request->id)
            {
                File::delete(public_path('images/landingpage_razenstudio/visual-branding-design/jasa-desain-grafis/desain-branding-kit/'.$value['gambar_konten']));
            } else {
                $array_konten[] = [
                    'id' => $value['id'],
                    'judul_konten' => $value['judul_konten'],
        ...
        $landingpage_razenstudio_desain_branding_kit = LandingpageRazenstudioDesainBrandingKit::find($get->id);
        $landingpage_razenstudio_desain_branding_kit->section_7 = json_encode($data);
        $landingpage_razenstudio_desain_branding_kit->save();
    ...
    public function section_8_store(Request $request)
    {
        ...
        $landingpage_razenstudio_desain_branding_kit->section_8 = json_encode($array);
        $landingpage_razenstudio_desain_branding_kit->save();
    ...
    public function section_8_hapus_satu(Request $request)
    {
        ...
        $landingpage_razenstudio_desain_branding_kit = LandingpageRazenstudioDesainBrandingKit::find($get->id);
        $landingpage_razenstudio_desain_branding_kit->section_8 = json_encode($data);
        $landingpage_razenstudio_desain_branding_kit->save();
