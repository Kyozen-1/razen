...
class TwitterController extends Controller
{
    ...
    {
        return view('razen-studio.admin.landing-page.social-media-engagement.twitter.index');
    }
    ...
    public function section_1_store(Request $request)
    {
        ...
        if($errors -> fails())
        {
            ...
            return redirect()->route('razen-studio.admin.social-media-engagement.twitter.index');
        }

        $cek = LandingpageRazenstudioSocialMediaEngagementTwitter::first();
        if($cek)
        {
            $landingpage_razenstudio_social_media_engagement_tik_tok = LandingpageRazenstudioSocialMediaEngagementTwitter::find($cek->id);
        } else {
            $landingpage_razenstudio_social_media_engagement_tik_tok = new LandingpageRazenstudioSocialMediaEngagementTwitter;
        }
        $array = [
            'title' => $request->title,
            'judul' => $request->judul,
        ...
        if($cek)
        {
            ...
            if($landingpage_razenstudio_social_media_engagement_tik_tok->section_2)
            {
                ...
                if ($request->gambar) {
                    ...
                    File::delete(public_path('images/landingpage_razenstudio/social-media-engagement/twitter/'.$gambarName));

                    $gambarExtension = $request->gambar->extension();
                    $gambarName =  uniqid().'-'.date("ymd").'.'.$gambarExtension;
                    $gambar = Image::make($request->gambar);
                    $gambarSize = public_path('images/landingpage_razenstudio/social-media-engagement/twitter/'.$gambarName);
    ...
    {
        $get = LandingpageRazenstudioSocialMediaEngagementTwitter::first();
        ...
        $landingpage_razenstudio_social_media_engagement_tik_tok = LandingpageRazenstudioSocialMediaEngagementTwitter::find($get->id);
