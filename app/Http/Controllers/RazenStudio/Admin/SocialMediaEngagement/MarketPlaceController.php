...
class MarketPlaceController extends Controller
{
    ...
    {
        return view('razen-studio.admin.landing-page.social-media-engagement.marketplace.index');
    }
    ...
    public function section_1_store(Request $request)
    {
        ...
        if($errors -> fails())
        {
            ...
            return redirect()->route('razen-studio.admin.social-media-engagement.marketplace.index');
        }

        $cek = LandingpageRazenstudioSocialMediaEngagementMarketplace::first();
        if($cek)
        {
            $landingpage_razenstudio_social_media_engagement_facebook = LandingpageRazenstudioSocialMediaEngagementMarketplace::find($cek->id);
        } else {
            $landingpage_razenstudio_social_media_engagement_facebook = new LandingpageRazenstudioSocialMediaEngagementMarketplace;
        }
        $array = [
            'title' => $request->title,
            'judul' => $request->judul,
        ...
        if($cek)
        {
            ...
            if($landingpage_razenstudio_social_media_engagement_facebook->section_2)
            {
                ...
                if ($request->gambar) {
                    ...
                    File::delete(public_path('images/landingpage_razenstudio/social-media-engagement/marketplace/'.$gambarName));

                    $gambarExtension = $request->gambar->extension();
                    $gambarName =  uniqid().'-'.date("ymd").'.'.$gambarExtension;
                    $gambar = Image::make($request->gambar);
                    $gambarSize = public_path('images/landingpage_razenstudio/social-media-engagement/marketplace/'.$gambarName);
    ...
    public function section_7_store(Request $request)
    {
        ...
        if($cek)
        {
            $landingpage_razenstudio_social_media_engagement_tik_tok = LandingpageRazenstudioSocialMediaEngagementMarketplace::find($cek->id);
        } else {
            $landingpage_razenstudio_social_media_engagement_tik_tok = new LandingpageRazenstudioSocialMediaEngagementMarketplace;
        }
    ...
    {
        $get = LandingpageRazenstudioSocialMediaEngagementMarketplace::first();
        ...
        $landingpage_razenstudio_social_media_engagement_tik_tok = LandingpageRazenstudioSocialMediaEngagementMarketplace::find($get->id);
