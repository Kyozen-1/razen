...
class CreateLandingpageRazenstudioIklanYoutubesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('landingpage_razenstudio_iklan_youtubes', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('landingpage_razenstudio_iklan_youtubes');
    }
}
