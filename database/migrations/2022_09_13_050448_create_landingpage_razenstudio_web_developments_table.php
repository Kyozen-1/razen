...
class CreateLandingpageRazenstudioWebDevelopmentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('landingpage_razenstudio_web_developments', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('landingpage_razenstudio_web_developments');
    }
}
