...
class CreateLandingpageRazenstudioDesainBrandingKitsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('landingpage_razenstudio_desain_branding_kits', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('landingpage_razenstudio_desain_branding_kits');
    }
}
