...
class CreateLandingpageRazenstudioDesainBrandingEventsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('landingpage_razenstudio_desain_branding_events', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('landingpage_razenstudio_desain_branding_events');
    }
}
