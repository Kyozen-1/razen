...
class CreateLandingpageRazenstudioIklanFacebooksTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('landingpage_razenstudio_iklan_facebooks', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('landingpage_razenstudio_iklan_facebooks');
    }
}
