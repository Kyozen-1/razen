...
class CreateLandingpageRazenstudioJasaBrandingDesignsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('landingpage_razenstudio_jasa_branding_designs', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('landingpage_razenstudio_jasa_branding_designs');
    }
}
