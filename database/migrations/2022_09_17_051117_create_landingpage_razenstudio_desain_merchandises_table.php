...
class CreateLandingpageRazenstudioDesainMerchandisesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('landingpage_razenstudio_desain_merchandises', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('landingpage_razenstudio_desain_merchandises');
    }
}
