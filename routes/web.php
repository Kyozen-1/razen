...
Route::get('razen-project/login','Auth\RazenProjectLoginController@showLoginForm')->name('razen-project.login');
Route::post('razen-project/login', 'Auth\RazenProjectLoginController@login')->name('razen-project.login.submit');
Route::get('razen-project/logout/', 'Auth\RazenProjectLoginController@logout')->name('razen-project.logout');
...
Route::prefix('razen-studio')->group(function(){
    Route::get('/', 'LandingPageRazenStudio\HomeController@home');
    ...
    Route::get('razen-studio-academy', 'LandingPageRazenStudio\HomeController@razen_studio_academy')->name('razen-studio-academy');
